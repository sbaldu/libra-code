...
*/
        ...
        if (ad_opt == 0 || ad_opt == 1) {
          adiabatic_opt = ad_opt;
        } else {
          cout << "Error in Hamiltonian_Extern::set_adiabatic_opt - allowed values are:\n";
          cout << "  0 - use provided adiabatic Hamiltonian and its derivatives directly "
                  "(default)\n";
          cout << "  1 - use provided diabatic Hamiltonian and its derivatives, and the "
                  "transformation from diabatic to adiabatic basis\n";
          exit(0);
        }
      }
...
*/
        ...
        if (vib_opt == 0 || vib_opt == 1) {
          vibronic_opt = vib_opt;
        } else {
          cout << "Error in Hamiltonian_Extern::set_vibronic_opt - allowed values are:\n";
          cout << "  0 - use provided vibronic Hamiltonian (default)\n";
          cout << "  1 - use provided diabatic and/or adiabatic Hamiltonian to compute vibronic "
                  "Hamiltonian\n";
          exit(0);
        }
      }
...
*/
        ...
        if (_ham_dia.n_cols != nelec) {
          ...
          cout << "Expected number of electronic DOF = " << nelec
               << " the number of cols in the input matrix is = " << _ham_dia.n_cols << "\n";
          exit(0);
        }
        if (_ham_dia.n_rows != nelec) {
          cout << "Error in Hamiltonian_Extern::bind_ham_dia\n";
          cout << "Expected number of electronic DOF = " << nelec
               << " the number of rows in the input matrix is = " << _ham_dia.n_rows << "\n";
          exit(0);
        }
...
*/
        ...
        if (sz != nnucl) {
          ...
          cout << "Expected number of nuclear DOF = " << nnucl
               << " the number of provided matrices = " << sz << "\n";
          exit(0);
        }
        if (sz > 0) {
          if (_d1ham_dia[0].n_cols != nelec) {
            cout << "Error in Hamiltonian_Extern::bind_d1ham_dia\n";
            cout << "Expected number of electronic DOF = " << nelec
                 << " the number of cols in the input matrix is = " << _d1ham_dia[0].n_cols << "\n";
            exit(0);
          }
          if (_d1ham_dia[0].n_rows != nelec) {
            cout << "Error in Hamiltonian_Extern::bind_d1ham_dia\n";
            cout << "Expected number of electronic DOF = " << nelec
                 << " the number of rows in the input matrix is = " << _d1ham_dia[0].n_rows << "\n";
            exit(0);
          }
        }
...
*/
        ...
        if (sz != nnucl * nnucl) {
          ...
          cout << "Expected number of elements in _d2ham_dia = " << nnucl * nnucl
               << " the number of provided matrices = " << sz << "\n";
          exit(0);
        }
        if (sz > 0) {
          if (_d2ham_dia[0].n_cols != nelec) {
            cout << "Error in Hamiltonian_Extern::bind_d2ham_dia\n";
            cout << "Expected number of electronic DOF = " << nelec
                 << " the number of cols in the input matrix is = " << _d2ham_dia[0].n_cols << "\n";
            exit(0);
          }
          if (_d2ham_dia[0].n_rows != nelec) {
            cout << "Error in Hamiltonian_Extern::bind_d2ham_dia\n";
            cout << "Expected number of electronic DOF = " << nelec
                 << " the number of rows in the input matrix is = " << _d2ham_dia[0].n_rows << "\n";
            exit(0);
          }
        }
...
*/
        ...
        if (_ham_adi.n_cols != nelec) {
          ...
          cout << "Expected number of electronic DOF = " << nelec
               << " the number of cols in the input matrix is = " << _ham_adi.n_cols << "\n";
          exit(0);
        }
        if (_ham_adi.n_rows != nelec) {
          cout << "Error in Hamiltonian_Extern::bind_ham_adi\n";
          cout << "Expected number of electronic DOF = " << nelec
               << " the number of rows in the input matrix is = " << _ham_adi.n_rows << "\n";
          exit(0);
        }
...
*/
        ...
        if (sz > 0) {
          if (_d1ham_adi[0].n_cols != nelec) {
            cout << "Error in Hamiltonian_Extern::bind_d1ham_adi\n";
            cout << "Expected number of electronic DOF = " << nelec
                 << " the number of cols in the input matrix is = " << _d1ham_adi[0].n_cols << "\n";
            exit(0);
          }
          if (_d1ham_adi[0].n_rows != nelec) {
            cout << "Error in Hamiltonian_Extern::bind_d1ham_adi\n";
            cout << "Expected number of electronic DOF = " << nelec
                 << " the number of rows in the input matrix is = " << _d1ham_adi[0].n_rows << "\n";
            exit(0);
          }
        }
...
*/
        ...
        if (_ham_vib.n_cols != nelec) {
          ...
          cout << "Expected number of electronic DOF = " << nelec
               << " the number of cols in the input matrix is = " << _ham_vib.n_cols << "\n";
          exit(0);
        }
        if (_ham_vib.n_rows != nelec) {
          cout << "Error in Hamiltonian_Extern::bind_ham_vib\n";
          cout << "Expected number of electronic DOF = " << nelec
               << " the number of rows in the input matrix is = " << _ham_vib.n_rows << "\n";
          exit(0);
        }
...
*/
        ...
        if (status_dia == 0) {  // only compute this is the result if not up to date
          ...
          if (bs_d1ham_dia == 0) {
            cout << "Error in Hamiltonian_Extern::compute_diabatic\n";
            cout << "Derivatives of diabatic Hamiltonian have not been bound to the "
                    "Hamiltonian_Extern object\n";
...
*/
        ...
        if (adiabatic_opt == 0) {
          ...
          if (status_adi == 0) {  // only compute this is the result if not up to date
            ...
            if (bs_ham_adi == 0) {
              cout << "Error in Hamiltonian_Extern::compute_adiabatic (with option adiabatic_opt "
                      "== 0)\n";
            ...
            if (bs_d1ham_adi == 0) {
              cout << "Error in Hamiltonian_Extern::compute_adiabatic (with option adiabatic_opt "
                      "== 0)\n";
              cout << "Derivatives of adiabatic Hamiltonian have not been bound to the "
                      "Hamiltonian_Extern object\n";
              cout << "use \"bind_d1ham_dia\" function\n";
              exit(0);
            }
