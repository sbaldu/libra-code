...
*/
    ...
    void update_Hamiltonian_q(dyn_control_params& prms,
                              MATRIX& q,
                              nHamiltonian& ham,
                              bp::object py_funct,
                              bp::object model_params) {
  ...
  */
      ...
      if (prms.rep_tdse == 1 && prms.rep_ham == 0) {
        need_adiabatic_call = 1;
      }

      // Using state-specific or Ehrenfest adiabatic forces, but the Hamiltonian is in diabatic rep
      if ((prms.force_method == 1 || prms.force_method == 2) && prms.rep_force == 1 &&
          prms.rep_ham == 0) {
        need_adiabatic_call = 1;
      }
...
*/
  ...
  */
    ...
    void update_Hamiltonian_q(
        bp::dict prms, MATRIX& q, nHamiltonian& ham, bp::object py_funct, bp::object model_params) {
      dyn_control_params _prms;
      _prms.set_parameters(prms);
    ...
    void update_Hamiltonian_q(bp::dict prms,
                              dyn_variables& dyn_var,
                              nHamiltonian& ham,
                              bp::object py_funct,
                              bp::object model_params) {
    ...
    void update_Hamiltonian_q_ethd(dyn_control_params& prms,
                                   MATRIX& q,
                                   MATRIX& p,
                                   nHamiltonian& ham,
                                   bp::object py_funct,
      ...
      if (prms.entanglement_opt == 0) { /* Nothing to do */
        ...
        ham.add_ethd_adi(q, invM, 1);
      } else if (prms.entanglement_opt == 2) {
        ham.add_ethd3_adi(q, invM, prms.ETHD3_alpha, 1);
      } else if (prms.entanglement_opt == 22) {
        ham.add_ethd3_adi(q, p, invM, prms.ETHD3_alpha, prms.ETHD3_beta, 1);
      } else {
        cout << "ERROR in update_Hamiltonian_q_ethd: The entanglement option = "
             << prms.entanglement_opt << " is not avaialable\n";
        exit(0);
    ...
    void update_Hamiltonian_q_ethd(bp::dict prms,
                                   MATRIX& q,
                                   MATRIX& p,
                                   nHamiltonian& ham,
                                   bp::object py_funct,
    ...
    void update_Hamiltonian_q_ethd(dyn_control_params& prms,
      ...
      if (prms.entanglement_opt == 0) { /* Nothing to do */
        ...
        ham.add_ethd_adi(*dyn_var.q, *dyn_var.iM, 1);
      } else if (prms.entanglement_opt == 2) {
        ham.add_ethd3_adi(*dyn_var.q, *dyn_var.iM, prms.ETHD3_alpha, 1);
      } else if (prms.entanglement_opt == 22) {
        ham.add_ethd3_adi(
            *dyn_var.q, *dyn_var.p, *dyn_var.iM, prms.ETHD3_alpha, prms.ETHD3_beta, 1);
      } else {
        cout << "ERROR in update_Hamiltonian_q_ethd: The entanglement option = "
             << prms.entanglement_opt << " is not avaialable\n";
        exit(0);
