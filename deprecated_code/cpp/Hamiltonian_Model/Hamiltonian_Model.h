...
*/
        ...
        MATRIX*
            basis_transform;  /// These are the eigenvalues of the Hamiltonian, C, in H * C = S * C * E
        MATRIX* basis_overlap;  /// Matrix of the basis functions overlaps , S, in H * C  = S * C * E

        vector<MATRIX*>
            d1basis_overlap;  ///< derivatives of the basis_overlap w.r.t. all atomic DOFs: q0, q1, .. qN-1
      ...
      public:
        ...
        void set_basis_overlap_derivs_by_ref(vector<MATRIX>& basis_overlap_derivs_,
                                             vector<int>& indxs_);
        void set_basis_overlap_derivs_by_val(vector<MATRIX>& basis_overlap_derivs_,
                                             vector<int>& indxs_);
      ...
      typedef std::vector<Hamiltonian_Model>
          Hamiltonian_ModelList;  /// data type for keeping a list of model Hamiltonians of their derived classes
