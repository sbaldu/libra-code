...
*/
        ...
        void (Ensemble::*expt_ham_set_ham_v1)(int i, std::string opt, int mopt) =
            &Ensemble::ham_set_ham;
        ...
        void (Ensemble::*expt_ham_set_params_v1)(int i, vector<double>& v) =
            &Ensemble::ham_set_params;
        void (Ensemble::*expt_ham_set_params_v2)(int i, boost::python::list v) =
            &Ensemble::ham_set_params;
        ...
        std::complex<double> (Ensemble::*expt_ham_dHdq_v1)(int traj, int i, int j, int n) =
            &Ensemble::ham_dHdq;
        std::complex<double> (Ensemble::*expt_ham_D_v1)(int traj, int i, int j, int n) =
            &Ensemble::ham_D;
        std::complex<double> (Ensemble::*expt_ham_nac_v1)(int traj, int i, int j) =
            &Ensemble::ham_nac;
        std::complex<double> (Ensemble::*expt_ham_Hvib_v1)(int traj, int i, int j) =
            &Ensemble::ham_Hvib;

        void (Ensemble::*expt_el_propagate_electronic_v1)(int i, double dt) =
            &Ensemble::el_propagate_electronic;
        void (Ensemble::*expt_el_propagate_electronic_v2)(double dt) =
            &Ensemble::el_propagate_electronic;
        ...
        void (Ensemble::*expt_se_pop_v1)(vector<double>& v, double xmax, double xmin) =
            &Ensemble::se_pop;
        void (Ensemble::*expt_se_pop_v2)(vector<double>& v) = &Ensemble::se_pop;
        boost::python::list (Ensemble::*expt_se_pop_v3)(double xmax, double xmin) =
            &Ensemble::se_pop;
        boost::python::list (Ensemble::*expt_se_pop_v4)() = &Ensemble::se_pop;

        void (Ensemble::*expt_sh_pop_v1)(vector<double>& v, double xmax, double xmin) =
            &Ensemble::sh_pop;
        void (Ensemble::*expt_sh_pop_v2)(vector<double>& v) = &Ensemble::sh_pop;
        boost::python::list (Ensemble::*expt_sh_pop_v3)(double xmax, double xmin) =
            &Ensemble::sh_pop;
        boost::python::list (Ensemble::*expt_sh_pop_v4)() = &Ensemble::sh_pop;

        void (Ensemble::*expt_sh_pop1_v1)(vector<double>& v, double xmax, double xmin) =
            &Ensemble::sh_pop1;
        void (Ensemble::*expt_sh_pop1_v2)(vector<double>& v) = &Ensemble::sh_pop1;
        boost::python::list (Ensemble::*expt_sh_pop1_v3)(double xmax, double xmin) =
            &Ensemble::sh_pop1;
