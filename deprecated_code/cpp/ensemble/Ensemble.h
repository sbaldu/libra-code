...
*/
      ...
      public:
        ...
        vector<int>
            is_active;  ///< flag stating if the i-th trajectory is active, if not - it is assumed to be fixed: no integration is applied
...
*/
        ...
        void print_map(std::string prefix,
                       double Xmin,
                       double Xmax,
                       double dx,
                       double Ymin,
                       double Ymax,
                       double dy,
                       int snap);  // for 2D projections on XY plane
        void integral_flux(vector<vector<double> >& Int_flx,
                           double Xmin,
                           double Xmax,
                           double dx,
                           double Ymin,
