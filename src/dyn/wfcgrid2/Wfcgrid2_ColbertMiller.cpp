...
*/
        ...
        for (i = 0; i < npts; i++) {
          for (j = 0; j < npts; j++) {
            if (i == j) {
              ...
              T_ij = 2.0 / double((i - j) * (i - j)) - 2.0 / double((i + j) * (i + j));
            }
      ...
      vector<CMATRIX> Wfcgrid2::T_PSI(vector<CMATRIX>& inp_psi,
                                      vector<int>& bc_type,
                                      vector<double>& mass,
...
*/
      ...
      vector<CMATRIX> Wfcgrid2::T_PSI_adi(vector<int>& bc_type,
                                          vector<double>& mass,
                                          complex<double> scaling) {
        return T_PSI(PSI_adi, bc_type, mass, scaling);
      }

      vector<CMATRIX> Wfcgrid2::T_PSI_dia(vector<int>& bc_type,
                                          vector<double>& mass,
                                          complex<double> scaling) {
        return T_PSI(PSI_dia, bc_type, mass, scaling);
      }

      CMATRIX Wfcgrid2::operator_T(vector<int>& bc_type,
                                   vector<double>& mass,
                                   complex<double> scaling) {
        /**
...
*/
      ...
      vector<CMATRIX> Wfcgrid2::nubla_PSI(int idof,
      ...
      vector<CMATRIX> Wfcgrid2::V_PSI(vector<CMATRIX>& V,
                                      vector<CMATRIX>& inp_psi,
                                      complex<double> scaling) {
        /**
