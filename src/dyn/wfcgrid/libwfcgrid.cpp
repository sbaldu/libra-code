...
*/
        ...
        vector<vector<int> > (*expt_compute_mapping_v2)(vector<vector<int> >& inp,
                                                        vector<int>& npts) = &compute_mapping;
        def("compute_mapping", expt_compute_mapping_v2);

        vector<int> (*expt_compute_hyperplane_v1)(
            vector<int>& npts, int idim_const, int ipt_const) = &compute_hyperplane;
        def("compute_hyperplane", expt_compute_hyperplane_v1);

        boost::python::list (Wfcgrid::*expt_absorb_1D)(double dL) = &Wfcgrid::absorb_1D;

        void (Wfcgrid::*expt_update_potential_1D_v1)(Hamiltonian& ham) =
            &Wfcgrid::update_potential_1D;
        void (Wfcgrid::*expt_update_potential_1D_v2)(bp::object py_funct, bp::object params) =
            &Wfcgrid::update_potential_1D;
        void (Wfcgrid::*expt_update_potential_2D_v1)(Hamiltonian& ham) =
            &Wfcgrid::update_potential_2D;
        void (Wfcgrid::*expt_update_potential_2D_v2)(bp::object py_funct, bp::object params) =
            &Wfcgrid::update_potential_2D;

        void (Wfcgrid::*expt_update_propagator_K_2D_v1)(double dt, double m1, double m2) =
            &Wfcgrid::update_propagator_K_2D;
        void (Wfcgrid::*expt_update_propagator_K_2D_v2)(double dt, double m0) =
            &Wfcgrid::update_propagator_K_2D;

        // Gaussian wavepackets
        void (Wfcgrid::*expt_init_wfc_1D_v1)(double x0, double px0, double dx, int init_state) =
            &Wfcgrid::init_wfc_1D;
        void (Wfcgrid::*expt_init_wfc_1D_v2)(vector<double>& x0,
                                             vector<double>& px0,
                                             vector<double>& dx,
        ...
        // Harmonic oscillator
        void (Wfcgrid::*expt_init_wfc_1D_HO_v1)(vector<int>& init_state,
                                                vector<int>& nu,
                                                vector<complex<double> >& weights,
                                                vector<double>& x0,
                                                vector<double>& px0,
                                                vector<double>& alpha) = &Wfcgrid::init_wfc_1D_HO;

        // Arbitrary wavefunction
        void (Wfcgrid::*expt_init_wfc_1D_ARB_v1)(bp::object py_funct, bp::object params) =
            &Wfcgrid::init_wfc_1D_ARB;
