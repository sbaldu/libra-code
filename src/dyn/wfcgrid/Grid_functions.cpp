...
*/
      ...
      void init_gauss_1D(vector<CMATRIX>& wfc,
                         CMATRIX& X,
                         double x_,
                         double px_,
                         double dx,
...
*/
      ...
      void add_gauss_1D(vector<CMATRIX>& wfc,
                        CMATRIX& X,
                        double x_,
                        double px_,
                        double dx,
...
*/
      ...
      void add_ho_1D(vector<CMATRIX>& wfc,
                     CMATRIX& X,
                     int nu,
                     double x_,
                     double px_,
...
*/
      ...
      void ft_1D(vector<CMATRIX>& psi,
                 vector<CMATRIX>& reci_psi,
                 int opt,
                 double xmin,
                 double kxmin,
                 double dx) {
          ...
          for (int nx = 0; nx < Nx; nx++) {
            for (int ny = 0; ny < Ny; ny++) {
              out << real(X.M[nx]) << "  " << real(Y.M[ny]) << "  "
                  << real(std::conj(PSI[st].M[nx * Ny + ny]) * PSI[st].M[nx * Ny + ny]) << endl;
            }  // for ny
            out << "\n";
          }  // for nx
