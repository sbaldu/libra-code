...
*/
        ...
        void (Thermostat::*expt_update_thermostat_forces_v1)(double, double, double) =
            &Thermostat::update_thermostat_forces;
        void (Thermostat::*expt_update_thermostat_forces_v2)(double, double, double, int) =
            &Thermostat::update_thermostat_forces;
        ...
        class_<ThermostatList>("ThermostatList").def(vector_indexing_suite<ThermostatList>());
