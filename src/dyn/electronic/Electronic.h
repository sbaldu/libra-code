...
*/
      ...
      public:
        ...
        void init(
            int,
            int,
            double);  ///< initialize object: 1-st parameter - the number of electronic DOF, 2-nd - the initial state index, 3-rd - the phase
        void init(
            int,
            int);  ///< initialize object: 1-st parameter - the number of electronic DOF, 2-nd - the initial state index
        ...
        std::complex<double> c(
            int i) const;  ///< return amplitude in the complex format: c_i = q_i + i*p_i
        std::complex<double> rho(
            int i, int j) const;  ///< return the density matrix element: rho_ij = c^*_i * c_j
...
*/ return &e1 == &e2;
      ...
      typedef std::vector<Electronic>
          ElectronicList;  ///< Type containing the vector of Electronic objects
