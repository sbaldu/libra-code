...
*/
        ...
        class_<ElectronicList>("ElectronicList").def(vector_indexing_suite<ElectronicList>());
        ...
        void (*expt_propagate_electronic_qtag2_v1)(double dt,
                                                   CMATRIX& Coeff,
                                                   CMATRIX& Hvib,
                                                   CMATRIX& Hvib_old,
                                                   CMATRIX& S,
                                                   CMATRIX& S_old) = &propagate_electronic_qtag2;
        def("propagate_electronic_qtag2", expt_propagate_electronic_qtag2_v1);

        void (*expt_propagate_electronic_rot_v1)(double dt, CMATRIX& Coeff, CMATRIX& Hvib) =
            &propagate_electronic_rot;
        def("propagate_electronic_rot", expt_propagate_electronic_rot_v1);

        void (*expt_propagate_electronic_eig_v1)(double dt, CMATRIX& Coeff, CMATRIX& Hvib) =
            &propagate_electronic_eig;
        def("propagate_electronic_eig", expt_propagate_electronic_eig_v1);

        void (*expt_propagate_electronic_eig_v2)(
            double dt, CMATRIX& Coeff, CMATRIX& Hvib, CMATRIX& S) = &propagate_electronic_eig;
        def("propagate_electronic_eig", expt_propagate_electronic_eig_v2);

        void (*expt_propagate_electronic_nonHermitian_v1)(
            double dt, CMATRIX& Coeff, CMATRIX& Hvib) = &propagate_electronic_nonHermitian;
        def("propagate_electronic_nonHermitian", expt_propagate_electronic_nonHermitian_v1);

        void (*expt_grid_propagator_v1)(double dt, CMATRIX& Hvib, CMATRIX& S, CMATRIX& U) =
            &grid_propagator;
        ...
        CMATRIX (*expt_unvectorize_density_matrix_v1)(CMATRIX& rho_vec) =
