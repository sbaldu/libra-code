...
namespace liblibra {
  ...
  namespace libdyn {
    ...
    namespace libgwp {
      ...
      complex<double> gwp_overlap(double q1,
                                  double p1,
                                  double gamma1,
                                  double alp1,
                                  double q2,
      ...
      complex<double> gwp_overlap(MATRIX& q1,
                                  MATRIX& p1,
                                  MATRIX& gamma1,
                                  MATRIX& alp1,
                                  MATRIX& q2,
      ...
      CMATRIX gwp_overlap_matrix(MATRIX& q1,
                                 MATRIX& p1,
                                 MATRIX& gamma1,
                                 MATRIX& alp1,
                                 MATRIX& q2,
      ...
      complex<double> gwp_overlap(MATRIX& R1,
                                  MATRIX& P1,
                                  double gamma1,
                                  MATRIX& R2,
                                  MATRIX& P2,
      ...
      complex<double> gwp_dipole(double q1,
                                 double p1,
                                 double gamma1,
                                 double alp1,
                                 double q2,
      ...
      complex<double> gwp_kinetic(double q1,
                                  double p1,
                                  double gamma1,
                                  double alp1,
                                  double q2,
      ...
      complex<double> gwp_kinetic(MATRIX& q1,
                                  MATRIX& p1,
                                  MATRIX& gamma1,
                                  MATRIX& alp1,
                                  MATRIX& q2,
      ...
      CMATRIX gwp_kinetic_matrix(MATRIX& q1,
                                 MATRIX& p1,
                                 MATRIX& gamma1,
                                 MATRIX& alp1,
                                 MATRIX& q2,
      ...
      complex<double> gwp_kinetic(MATRIX& R1,
                                  MATRIX& P1,
                                  double gamma1,
                                  MATRIX& R2,
                                  MATRIX& P2,
