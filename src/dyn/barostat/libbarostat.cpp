...
*/
        ...
        void (Barostat::*expt_update_barostat_forces_v1)(
            double ekin_tr, double ekin_rot, double curr_volume, double curr_pressure) =
            &Barostat::update_barostat_forces;
        void (Barostat::*expt_update_barostat_forces_v2)(
            double ekin_tr, double ekin_rot, double curr_volume, MATRIX3x3& curr_pressure_tensor) =
            &Barostat::update_barostat_forces;
