...
namespace liblibra {
  ...
  namespace libdyn {
    ...
    void export_dyn_control_params_objects() {
      ...
      void (dyn_control_params::*expt_sanity_check_v1)(boost::python::dict params) =
          &dyn_control_params::set_parameters;
      void (dyn_control_params::*expt_set_parameters_v1)(boost::python::dict params) =
          &dyn_control_params::set_parameters;
      ...
      class_<dyn_control_params>("dyn_control_params", init<>())
          ...
          .def_readwrite("use_Jasper_Truhlar_criterion",
                         &dyn_control_params::use_Jasper_Truhlar_criterion)
          ...
          .def_readwrite("dish_decoherence_event_option",
                         &dyn_control_params::dish_decoherence_event_option)
          .def_readwrite("decoherence_times_type", &dyn_control_params::decoherence_times_type)
          .def_readwrite("schwartz_decoherence_inv_alpha",
                         &dyn_control_params::schwartz_decoherence_inv_alpha)
          .def_readwrite("schwartz_interaction_width",
                         &dyn_control_params::schwartz_interaction_width)
          ...
          .def_readwrite("instantaneous_decoherence_variant",
                         &dyn_control_params::instantaneous_decoherence_variant)
          ...
          .def_readwrite("ampl_transformation_method",
                         &dyn_control_params::ampl_transformation_method)
    ...
    void export_dyn_variables_objects() {
      ...
      CMATRIX (dyn_variables::*expt_get_dm_adi_v1)(int i, int prev_steps) =
          &dyn_variables::get_dm_adi;
      CMATRIX (dyn_variables::*expt_get_dm_adi_v2)(int i) = &dyn_variables::get_dm_adi;

      CMATRIX (dyn_variables::*expt_get_dm_dia_v1)(int i, int prev_steps) =
          &dyn_variables::get_dm_dia;
      ...
      // Arbitrary wavefunction
      void (dyn_variables::*expt_set_parameters_v1)(boost::python::dict params) =
          &dyn_variables::set_parameters;

      void (dyn_variables::*expt_update_amplitudes_v1)(dyn_control_params& dyn_params) =
          &dyn_variables::update_amplitudes;
      ...
      void (dyn_variables::*expt_update_amplitudes_v3)(bp::dict dyn_params, nHamiltonian& ham) =
          &dyn_variables::update_amplitudes;
      void (dyn_variables::*expt_update_amplitudes_v4)(
          dyn_control_params& dyn_params, bp::object compute_model, bp::dict model_params) =
          &dyn_variables::update_amplitudes;
      void (dyn_variables::*expt_update_amplitudes_v5)(
          bp::dict dyn_params, bp::object compute_model, bp::dict model_params) =
          &dyn_variables::update_amplitudes;

      void (dyn_variables::*expt_update_density_matrix_v1)(dyn_control_params& dyn_params) =
          &dyn_variables::update_density_matrix;
      void (dyn_variables::*expt_update_density_matrix_v2)(
          dyn_control_params& dyn_params, nHamiltonian& ham, int lvl) =
          &dyn_variables::update_density_matrix;
      ...
      void (dyn_variables::*expt_update_density_matrix_v4)(dyn_control_params& dyn_params,
                                                           bp::object compute_model,
                                                           bp::dict model_params,
                                                           int lvl) =
          &dyn_variables::update_density_matrix;
      void (dyn_variables::*expt_update_density_matrix_v5)(
          bp::dict dyn_params, bp::object compute_model, bp::dict model_params, int lvl) =
          &dyn_variables::update_density_matrix;

      double (dyn_variables::*expt_compute_average_kinetic_energy_v1)() =
          &dyn_variables::compute_average_kinetic_energy;
      double (dyn_variables::*expt_compute_average_kinetic_energy_v2)(vector<int>& which_dofs) =
          &dyn_variables::compute_average_kinetic_energy;
      double (dyn_variables::*expt_compute_kinetic_energy_v1)(int itraj) =
          &dyn_variables::compute_kinetic_energy;
      double (dyn_variables::*expt_compute_kinetic_energy_v2)(int itraj, vector<int>& which_dofs) =
          &dyn_variables::compute_kinetic_energy;
      vector<double> (dyn_variables::*expt_compute_kinetic_energies_v1)() =
          &dyn_variables::compute_kinetic_energies;
      vector<double> (dyn_variables::*expt_compute_kinetic_energies_v2)(vector<int>& which_dofs) =
          &dyn_variables::compute_kinetic_energies;

      void (dyn_variables::*expt_update_active_states_v1)(int direction, int property) =
          &dyn_variables::update_active_states;
      void (dyn_variables::*expt_update_active_states_v2)() = &dyn_variables::update_active_states;

      void (dyn_variables::*expt_set_active_states_diff_rep_v1)(int rep_sh, Random& rnd) =
          &dyn_variables::set_active_states_diff_rep;
      ...
      class_<dyn_variables>("dyn_variables", init<int, int, int, int>())
          ...
          .def_readwrite("simple_decoherence_vars_status",
                         &dyn_variables::simple_decoherence_vars_status)
    ...
    void export_dyn_decoherence_objects() {
      ...
      void (*expt_instantaneous_decoherence_v1)(CMATRIX& Coeff,
                                                ...
                                                int collapse_option) = &instantaneous_decoherence;
      ...
      void (*expt_wp_reversal_events_v1)(dyn_variables& dyn_var, nHamiltonian& ham, double dt) =
          &wp_reversal_events;
      ...
      void (*expt_xf_hop_reset)(
          dyn_variables& dyn_var, vector<int>& accepted_states, vector<int>& initial_states) =
          &xf_hop_reset;
      def("xf_hop_reset", expt_xf_hop_reset);

      void (*expt_update_ham_xf)(dyn_variables& dyn_var) = &update_ham_xf;
      def("update_ham_xf", expt_update_ham_xf);

      void (*expt_shxf_v1)(dyn_variables& dyn_var,
                           nHamiltonian& ham,
                           nHamiltonian& ham_prev,
                           dyn_control_params& prms) = &shxf;
      def("shxf", expt_shxf_v1);

      void (*expt_mqcxf_v1)(dyn_variables& dyn_var,
                            nHamiltonian& ham,
                            nHamiltonian& ham_prev,
                            dyn_control_params& prms) = &mqcxf;
      ...
      vector<MATRIX> (*expt_edc_rates_v3)(vector<CMATRIX>& Hvib,
                                          vector<double>& Ekin,
                                          double C_param,
                                          double eps_param,
                                          int isNBRA) = &edc_rates;
      def("edc_rates", expt_edc_rates_v3);

      vector<MATRIX> (*expt_edc_rates_v4)(vector<CMATRIX>& Hvib,
                                          vector<double>& Ekin,
                                          double C_param,
                                          double eps_param,
                                          int isNBRA) = &edc_rates;
      ...
      void (*expt_dephasing_informed_correction_v1)(
          MATRIX& decoh_rates, CMATRIX& Hvib, MATRIX& ave_gaps, int isNBRA) =
      ...
      void (*expt_dephasing_informed_correction_v3)(
          vector<MATRIX>& decoh_rates, vector<CMATRIX>& Hvib, MATRIX& ave_gaps, int isNBRA) =
          &dephasing_informed_correction;
      def("dephasing_informed_correction", expt_dephasing_informed_correction_v3);

      void (*expt_dephasing_informed_correction_v4)(
          vector<MATRIX>& decoh_rates, vector<CMATRIX>& Hvib, MATRIX& ave_gaps) =
          &dephasing_informed_correction;
      ...
      MATRIX (*expt_coherence_intervals_v2)(CMATRIX& Coeff, vector<MATRIX>& rates) =
          &coherence_intervals;
      def("coherence_intervals", expt_coherence_intervals_v2);

      vector<MATRIX> (*expt_schwartz_1_v1)(
          dyn_control_params& prms, CMATRIX& amplitudes, nHamiltonian& ham, MATRIX& inv_alp) =
          &schwartz_1;
      ...
      vector<MATRIX> (*expt_Gu_Franco_v1)(dyn_control_params& prms, CMATRIX& amplitudes) =
          &Gu_Franco;
...
*/
      ...
      vector<int> (*expt_dish_v1)(dyn_variables& dyn_var,
                                  nHamiltonian& ham,
                                  vector<MATRIX>& decoherence_rates,
      ...
      void (*expt_dish_rev2023_v1)(dyn_variables& dyn_var,
                                   nHamiltonian& ham,
                                   vector<MATRIX>& decoherence_rates,
                                   dyn_control_params& prms,
                                   Random& rnd) = &dish_rev2023;
      ...
      void (*expt_integrate_afssh_moments_v1)(CMATRIX& dR,
                                              CMATRIX& dP,
                                              CMATRIX& Hvib,
                                              CMATRIX& F,
                                              CMATRIX& C,
                                              ...
                                              int act_state,
                                              double dt,
                                              int nsteps) = &integrate_afssh_moments;
    ...
    void export_dyn_hop_acceptance_objects() {
      ...
      int (*expt_can_rescale_along_vector_v2)(
          double E_old, double E_new, MATRIX& p, MATRIX& invM, MATRIX& t) =
          &can_rescale_along_vector;
      def("can_rescale_along_vector", expt_can_rescale_along_vector_v2);

      void (*expt_rescale_along_vector_v1)(double E_old,
                                           double E_new,
                                           MATRIX& p,
                                           MATRIX& invM,
                                           MATRIX& t,
                                           int do_reverse,
                                           vector<int>& which_dofs) = &rescale_along_vector;
      ...
      vector<double> (*expt_Boltz_quant_prob_v1)(vector<double>& E, double T) = &Boltz_quant_prob;
      ...
      double (*expt_boltz_factor_v1)(double E_new, double E_old, double T, int boltz_opt) =
          &boltz_factor;
...
*/
      ...
      vector<int> (*expt_accept_hops_v1)(dyn_variables& dyn_var,
                                         nHamiltonian& ham,
                                         vector<int>& proposed_states,
                                         vector<int>& initial_states,
                                         dyn_control_params& prms,
      ...
      vector<int> (*expt_accept_hops_v2)(dyn_variables& dyn_var,
                                         nHamiltonian& ham,
                                         vector<int>& proposed_states,
                                         vector<int>& initial_states,
                                         dyn_control_params& prms,
                                         Random& rnd) = &accept_hops;
      def("accept_hops", expt_accept_hops_v2);
...
*/
      vector<int> (*expt_where_can_we_hop_v1)(int traj,
                                              dyn_variables& dyn_var,
                                              nHamiltonian& ham,
                                              dyn_control_params& prms,
                                              Random& rnd) = &where_can_we_hop;
      def("where_can_we_hop", expt_where_can_we_hop_v1);
...
*/
      ...
      void (*expt_handle_hops_nuclear_v1)(dyn_variables& dyn_var,
                                          nHamiltonian& ham,
                                          vector<int>& new_states,
                                          vector<int>& old_states,
                                          dyn_control_params& prms) = &handle_hops_nuclear;
    ...
    void export_dyn_hop_proposal_objects() {
      ...
      vector<double> (*expt_hopping_probabilities_fssh_v2)(
          dyn_control_params& prms, CMATRIX& denmat, CMATRIX& Hvib, int act_state_indx) =
      ...
      vector<double> (*expt_hopping_probabilities_gfsh_orig_v1)(
          dyn_control_params& prms, CMATRIX& denmat, CMATRIX& denmat_old, int act_state_indx) =
      ...
      vector<double> (*expt_hopping_probabilities_fssh3_v1)(dyn_control_params& prms,
                                                            CMATRIX& denmat,
                                                            CMATRIX& denmat_old,
                                                            int act_state_indx,
      ...
      vector<double> (*expt_hopping_probabilities_lz_v1)(nHamiltonian& ham,
                                                         nHamiltonian& ham_prev,
                                                         int act_state_indx,
                                                         int rep,
                                                         MATRIX& p,
      ...
      vector<double> (*expt_hopping_probabilities_zn_v1)(nHamiltonian& ham,
                                                         nHamiltonian& ham_prev,
                                                         int act_state_indx,
                                                         int rep,
                                                         MATRIX& p,
      ...
      vector<MATRIX> (*expt_hop_proposal_probabilities_v1)(dyn_control_params& prms,
                                                           MATRIX& q,
                                                           MATRIX& p,
                                                           MATRIX& invM,
                                                           CMATRIX& C,
      ...
      vector<vector<double> > (*expt_hop_proposal_probabilities_v2)(dyn_control_params& prms,
                                                                    dyn_variables& dyn_var,
                                                                    nHamiltonian& ham,
                                                                    nHamiltonian& ham_prev) =
          &hop_proposal_probabilities;
      ...
      vector<int> (*expt_propose_hops_v1)(vector<MATRIX>& g, vector<int>& act_states, Random& rnd) =
          &propose_hops;
    ...
    void export_dyn_methods_objects() {
      vector<int> (*expt_decoherence_event_v1)(MATRIX& coherence_time,
                                               MATRIX& coherence_interval,
                                               int decoherence_event_option,
                                               Random& rnd) = &decoherence_event;
      ...
      vector<int> (*expt_dish_hop_proposal_v1)(vector<int>& act_states,
                                               CMATRIX& Coeff,
                                               MATRIX& coherence_time,
                                               vector<MATRIX>& decoherence_rates,
                                               Random& rnd) = &dish_hop_proposal;
      def("dish_hop_proposal", expt_dish_hop_proposal_v1);

      void (*expt_dish_project_out_collapse_v1)(vector<int>& old_states,
                                                vector<int>& proposed_states,
                                                vector<int>& new_states,
                                                CMATRIX& Coeff,
                                                MATRIX& coherence_time,
                                                int collapse_option) = &dish_project_out_collapse;
    ...
    void export_dyn_projectors_objects() {
      ...
      CMATRIX (*expt_compute_phase_corrections_v1)(CMATRIX& S, double tol) =
      ...
      MATRIX (*expt_make_cost_mat_v1)(CMATRIX& orb_mat_inp, CMATRIX& en_mat_inp, double alpha) =
          &make_cost_mat;
      def("make_cost_mat", expt_make_cost_mat_v1);

      vector<int> (*expt_Munkres_Kuhn_v1)(
          CMATRIX& orb_mat_inp, CMATRIX& en_mat_inp, double alpha, int verbosity) = &Munkres_Kuhn;
      ...
      vector<int> (*expt_permute_states_v1)(vector<vector<int> >& perms, vector<int>& act_states) =
          &permute_states;
      def("permute_states", expt_permute_states_v1);

      void (*expt_update_projectors_v1)(dyn_control_params& prms,
                                        vector<CMATRIX>& projectors,
                                        vector<CMATRIX>& Eadi,
                                        vector<CMATRIX>& St,
                                        Random& rnd) = &update_projectors;
      def("update_projectors", expt_update_projectors_v1);

      vector<vector<int> > (*expt_compute_permutations_v1)(
          dyn_control_params& prms, vector<CMATRIX>& Eadi, vector<CMATRIX>& St, Random& rnd) =
...
*/
      ...
      vector<int> (*expt_get_stochastic_reordering_v1)(CMATRIX& time_overlap, Random& rnd) =
          &get_stochastic_reordering;
      def("get_stochastic_reordering", expt_get_stochastic_reordering_v1);

      vector<int> (*expt_get_stochastic_reordering2_v1)(CMATRIX& time_overlap, Random& rnd) =
      ...
      vector<int> (*expt_get_stochastic_reordering3_v2)(CMATRIX& time_overlap,
                                                        Random& rnd,
                                                        int convergence,
      ...
      (CMATRIX & F_curr,
       ...
       MATRIX & iM,
       double dt,
       int act_state) = &compute_F_cost_matrix;
      def("compute_F_cost_matrix", expt_compute_F_cost_matrix_v1);

      vector<MATRIX> (*expt_compute_F_cost_matrix_dof_resolved_v1)(CMATRIX& F_curr,
                                                                   CMATRIX& F_prev,
                                                                   MATRIX& e_curr,
                                                                   MATRIX& e_prev,
                                                                   MATRIX& _p,
...
*/
    ...
    void export_permutation_objects() {
      ...
      vector<int> (*expt_Munkres_Kuhn_minimize_v1)(MATRIX& _X, int verbosity) =
          &Munkres_Kuhn_minimize;
      vector<int> (*expt_Munkres_Kuhn_maximize_v1)(MATRIX& _X, int verbosity) =
          &Munkres_Kuhn_maximize;
    ...
    void export_Energy_Forces_objects() {
      double (*expt_compute_kinetic_energy_v11)(MATRIX& p, MATRIX& invM, vector<int>& which_dofs) =
      ...
      vector<double> (*expt_compute_kinetic_energies_v1)(
          MATRIX& p, MATRIX& invM, vector<int>& which_dofs) = &compute_kinetic_energies;
      def("compute_kinetic_energies", expt_compute_kinetic_energies_v1);

      vector<double> (*expt_compute_kinetic_energies_v2)(MATRIX& p, MATRIX& invM) =
      ...
      double (*expt_average_potential_energy_v1)(
          dyn_control_params& prms, dyn_variables& dyn_vars, nHamiltonian& ham) =
      ...
      void (*expt_update_forces_v2)(bp::dict params, dyn_variables& dynvars, nHamiltonian& ham) =
          &update_forces;
    ...
    void export_dyn_ham() {
      void (*expt_update_Hamiltonian_variables_v1)(dyn_control_params& prms,
                                                   dyn_variables& dyn_var,
                                                   nHamiltonian& ham,
                                                   nHamiltonian& ham_prev,
                                                   bp::object py_funct,
                                                   bp::object model_params,
                                                   int update_type) = &update_Hamiltonian_variables;

      void (*expt_update_Hamiltonian_variables_v2)(bp::dict prms,
                                                   dyn_variables& dyn_var,
                                                   nHamiltonian& ham,
                                                   nHamiltonian& ham_prev,
                                                   bp::object py_funct,
      ...
      void (*expt_update_time_overlaps_v1)(dyn_control_params& prms,
                                           dyn_variables& dyn_var,
                                           nHamiltonian& ham,
                                           nHamiltonian& ham_prev) = &update_time_overlaps;
      def("update_time_overlaps", expt_update_time_overlaps_v1);

      void (*expt_update_proj_adi_v1)(dyn_control_params& prms,
                                      dyn_variables& dyn_var,
                                      nHamiltonian& Ham,
...
*/
      ...
      vector<CMATRIX> (*expt_compute_St_v3)(nHamiltonian& ham, nHamiltonian& ham_prev, int isNBRA) =
          &compute_St;
      def("compute_St", expt_compute_St_v3);
      vector<CMATRIX> (*expt_compute_St_v4)(nHamiltonian& ham, nHamiltonian& ham_prev) =
          &compute_St;
      ...
      int (*expt_need_active_states_diff_rep_v1)(dyn_control_params& prms) =
          need_active_states_diff_rep;
      def("need_active_states_diff_rep", expt_need_active_states_diff_rep_v1);

      void (*expt_propagate_electronic_v1)(dyn_variables& dyn_var,
                                           nHamiltonian& ham,
                                           nHamiltonian& ham_prev,
                                           dyn_control_params& prms) = &propagate_electronic;
      def("propagate_electronic", expt_propagate_electronic_v1);

      void (*expt_propagate_electronic_kcrpmd_v1)(
          dyn_variables& dyn_var, nHamiltonian& ham, dyn_control_params& prms, Random& rnd) =
          &propagate_electronic_kcrpmd;
...
*/
      void (*expt_compute_dynamics_v4)(dyn_variables& dyn_var,
                                       bp::dict dyn_params,
                                       nHamiltonian& ham,
