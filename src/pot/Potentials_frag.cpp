...
namespace liblibra {
  ...
  namespace libpot {
    ...
    double Gay_Berne(VECTOR& ri,
      ...
      //-------------- Derivatives ----------------------
      dUdr =
          (8.0 * e * mu * Hp / (e2 * d)) * (R12 - R6) -
          (24.0 * e / (dw * s0)) * R * (2.0 * R12 - R6) * (1.0 + (s * s * s * H / (s0 * s0 * d)));

      dUda = (-8.0 * e * mu / (d * e2)) * (R12 - R6) * (xp * ap2 * a - xp * xp * b * g) /
                 (1.0 - xp * xp * g * g) +
             (24.0 * e * s * s * s / (d * s0 * s0 * s0 * dw)) * R * (2.0 * R12 - R6) *
                 (xa2 * a - x2 * b * g) / (1.0 - x2 * g * g);

      dUdb = (-8.0 * e * mu / (d * e2)) * (R12 - R6) * ((xp / ap2) * b - xp * xp * a * g) /
                 (1.0 - xp * xp * g * g) +
             (24.0 * e * s * s * s / (d * s0 * s0 * s0 * dw)) * R * (2.0 * R12 - R6) *
                 (xam2 * b - x2 * a * g) / (1.0 - x2 * g * g);

      dUdg = (4.0 * e * nu) * (R12 - R6) * (x2 * g) / (1.0 - x2 * g * g) +
             ((8.0 * e * mu / e2) * (R12 - R6) * (xp * xp * a * b - Hp * xp * xp * g) /
              (1.0 - xp * xp * g * g)) +
             (24.0 * e * s * s * s / (s0 * s0 * s0 * dw)) * R * (R6 - 2.0 * R12) *
                 (x2 * a * b - H * x2 * g) / (1 - x2 * g * g);
...
**********************************************************/
      ...
      // Energy
      energy =
          -alp * ((sm3 / s) + (sp3 / s) - 2.0 * s4) + bet * ((sm9 / s) + (sp9 / s) - 2.0 * s10);

      // Force
      f_mod = -alp * ((sm3 * s2) + (3.0 * sm3 * sm / s) + (sp3 * s2) + (3.0 * sp3 * sp / s) -
                      8.0 * (s4 / s)) +
              bet * ((sm9 * s2) + (9.0 * sm9 * sm / s) + (sp9 * s2) + (9.0 * sp9 * sp / s) -
                     20.0 * (s10 / s));
