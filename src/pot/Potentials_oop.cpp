...
namespace liblibra {
  ...
  namespace libpot {
    ...
    double OOP_Fourier_old(VECTOR& r1,
                           VECTOR& r2,
                           VECTOR& r3,
                           VECTOR& r4, /*Inputs*/
                           VECTOR& f1,
      ...
      if (opt == 0) {
        direction = 1.0;
      }  // This defines TORSION angle
      if (opt == 1) {
        direction = -1.0;
      }  // This defines DIHEDRAL angle
    ...
    double OOP_Wilson(VECTOR& r1,
      ...
      double modt, modu, cos_phi, sin_phi, cos_teta_ijk, sin_teta_ijk, tan_teta_ijk, phi, K1, K2,
          energy, dij, dkj, dlj;
      VECTOR ri, rj, rk, rl, fi, fj, fk, fl;
      energy = 0.0;
      f1 = f2 = f3 = f4 = 0.0;
    ...
    double OOP_Harmonic(VECTOR& r0,
      ...
      tmp1.skew(r32);
      tmp3.skew(r12);
      dndr1.tensor_product(p1, N);
      dndr1 = (dndr1 + (tmp1 / modN));
      dndr3.tensor_product(p3, N);
      dndr3 = (dndr3 - (tmp3 / modN));
