...
*/
      ...
      boost::python::list (*expt_Bond_Harmonic_v2)(VECTOR, VECTOR, double, double, int) =
          &Bond_Harmonic;
      ...
      boost::python::list (*expt_Angle_Harmonic)(VECTOR, VECTOR, VECTOR, double, double) =
          &Angle_Harmonic;
      boost::python::list (*expt_Angle_Fourier)(
          VECTOR, VECTOR, VECTOR, double, double, double, double, int) = &Angle_Fourier;
      boost::python::list (*expt_Angle_Fourier_General)(
          VECTOR, VECTOR, VECTOR, double, double, double, double) = &Angle_Fourier_General;
      boost::python::list (*expt_Angle_Fourier_Special)(VECTOR, VECTOR, VECTOR, double, int) =
          &Angle_Fourier_Special;
      boost::python::list (*expt_Angle_Harmonic_Cos)(VECTOR, VECTOR, VECTOR, double, double, int) =
          &Angle_Harmonic_Cos;
      boost::python::list (*expt_Angle_Harmonic_Cos_General)(
          VECTOR, VECTOR, VECTOR, double, double) = &Angle_Harmonic_Cos_General;
      boost::python::list (*expt_Angle_Cubic)(VECTOR, VECTOR, VECTOR, double, double) =
          &Angle_Cubic;

      double (*expt_Elec_Ewald3D_v1)(vector<VECTOR>& r,
                                     vector<double>& q,
                                     MATRIX3x3& box,
                                     double epsilon,
                                     vector<VECTOR>& f,
                                     ...
                                     double etha,
                                     double R_on,
                                     double R_off) = &Elec_Ewald3D;

      double (*expt_VdW_Ewald3D_v1)(vector<VECTOR>& r,
                                    vector<int>& types,
                                    int max_type,
                                    vector<double>& Bij,
      ...
      double (*expt_VdW_Ewald3D_v2)(vector<VECTOR>& r,
                                    vector<double>& q,
                                    MATRIX3x3& box,
                                    vector<VECTOR>& f,
                                    MATRIX3x3& at_stress,
