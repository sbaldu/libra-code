  ...
  namespace libpot {
    ...
    double Angle_Fourier_Special(VECTOR& r1,
      ...
      switch (coordination) {
        case 1: {
          energy = k_ijk *
                   (1.0 + cos_theta);  // Note! in UFF article there is "-" in front of cos(theta)
    ...
    boost::python::list Angle_Fourier_General(VECTOR r1,
                                              VECTOR r2,
                                              VECTOR r3, /* Inputs */
                                              double k_ijk,
                                              double C0,
    ...
    boost::python::list Angle_Fourier_Special(VECTOR r1,
                                              VECTOR r2,
                                              VECTOR r3, /* Inputs */
                                              double k_ijk,
                                              int coordination) {
