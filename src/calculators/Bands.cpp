...
*/
      ...
      if (0) {  // For debug
        ...
        for (i = 0; i < Norb; i++) {
          cout << "i= " << i << " orb_indx = " << in[i].first << " E[i]= " << in[i].second << endl;
        }
      }
...
*/
    ...
    void populate_bands(double Nel,
                        double degen,
                        double kT,
                        double etol,
                        int pop_opt,
...
*/
    ...
    boost::python::list populate_bands(
...
*/
      ...
      for (int i = 0; i < sz; i++) {
        cout << " band# = " << i << " mo indx =" << bands[i].first
             << " energy(eV) = " << bands[i].second / eV << " energy(a.u.) = " << bands[i].second
