...
*/
      ...
      double (*expt_fermi_population_v1)(double e, double ef, double degen, double kT) =
          &fermi_population;

      double (*expt_fermi_integral_v1)(vector<double>& bnds, double ef, double degen, double kT) =
          &fermi_integral;
      ...
      double (*expt_fermi_energy_v2)(
          boost::python::list bnds, double Nel, double degen, double kT, double etol) =
          &fermi_energy;
      ...
      boost::python::list (*expt_populate_bands_v1)(
          double Nel, double degen, double kT, double etol, int pop_opt, boost::python::list bands) =
          &populate_bands;
      ...
      //----------------- Density_Matrix.cpp ------------------------
      MATRIX (*expt_compute_density_matrix_v1)(boost::python::list occ, MATRIX C) =
          &compute_density_matrix;
      CMATRIX (*expt_compute_density_matrix_v2)(boost::python::list occ, CMATRIX C) =
          &compute_density_matrix;

      boost::python::list (*expt_Fock_to_P_v1)(
          MATRIX Fao, MATRIX Sao, double Nel, double degen, double kT, double etol, int pop_opt) =
          &Fock_to_P;
      boost::python::list (*expt_Fock_to_P_v2)(
      ...
      double (*expt_energy_elec_v2)(MATRIX P_alp,
                                    MATRIX P_bet,
                                    MATRIX Hao_alp,
                                    MATRIX Hao_bet,
                                    MATRIX Fao_alp,
      ...
      double (*expt_energy_nucl_v2)(vector<VECTOR>& R, vector<double>& Zeff, vector<VECTOR>& G) =
          &energy_nucl;
      ...
      boost::python::list (*expt_update_Mull_charges_v1)(vector<int>& ao_to_atom_map,
                                                         vector<double>& Zeff,
