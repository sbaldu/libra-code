...
namespace liblibra {
  ...
  namespace libnhamiltonian {
    ...
    bp::object import_py_funct(const std::string& module,
      ...
      bp::exec(
          "import imp\n"
          "new_module = imp.load_module(module_name, open(path), path, ('py', 'U', "
          "imp.PY_SOURCE))\n",
          globals,
          locals);
    ...
    void nHamiltonian::compute_diabatic(int model,
                                        vector<double>& q,
