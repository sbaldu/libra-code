...
*/
      ...
      CMATRIX (nHamiltonian::*expt_get_dc1_dia_v2)(int i, vector<int>&) =
          &nHamiltonian::get_dc1_dia;
      ...
      CMATRIX (nHamiltonian::*expt_get_d1ham_dia_v2)(int i, vector<int>&) =
          &nHamiltonian::get_d1ham_dia;

      CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v11)(int i) = &nHamiltonian::get_d2ham_dia;
      CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v12)(int i, vector<int>&) =
          &nHamiltonian::get_d2ham_dia;

      CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v21)(int i, int j) = &nHamiltonian::get_d2ham_dia;
      CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v22)(int i, int j, vector<int>&) =
          &nHamiltonian::get_d2ham_dia;

      CMATRIX (nHamiltonian::*expt_get_dc1_adi_v1)(int i) = &nHamiltonian::get_dc1_adi;
      CMATRIX (nHamiltonian::*expt_get_dc1_adi_v2)(int i, vector<int>&) =
          &nHamiltonian::get_dc1_adi;
      ...
      CMATRIX (nHamiltonian::*expt_get_cum_phase_corr_v2)(vector<int>&) =
      ...
      void (nHamiltonian::*expt_compute_diabatic_v2)(
          int model, vector<double>& q, vector<double>& params) = &nHamiltonian::compute_diabatic;
...
*/
      ...
      void (nHamiltonian::*expt_compute_diabatic_v4)(
          bp::object py_funct, MATRIX& q, bp::object params) = &nHamiltonian::compute_diabatic;
...
*/
      ...
      void (nHamiltonian::*expt_compute_adiabatic_v4)(
          bp::object py_funct, MATRIX& q, bp::object params) = &nHamiltonian::compute_adiabatic;
...
*/
      ...
      void (nHamiltonian::*expt_ampl_dia2adi_v2)(
          CMATRIX& ampl_dia, CMATRIX& ampl_adi, vector<int>& id_) = &nHamiltonian::ampl_dia2adi;
      void (nHamiltonian::*expt_ampl_dia2adi_v3)(
          CMATRIX& ampl_dia, CMATRIX& ampl_adi, int lvl, int split) = &nHamiltonian::ampl_dia2adi;
      ...
      void (nHamiltonian::*expt_ampl_adi2dia_v2)(
          CMATRIX& ampl_dia, CMATRIX& ampl_adi, vector<int>& id_) = &nHamiltonian::ampl_adi2dia;
      void (nHamiltonian::*expt_ampl_adi2dia_v3)(
          CMATRIX& ampl_dia, CMATRIX& ampl_adi, int lvl, int split) = &nHamiltonian::ampl_adi2dia;

      void (nHamiltonian::*expt_compute_nac_dia_v1)(MATRIX& p, const MATRIX& invM) =
          &nHamiltonian::compute_nac_dia;
      void (nHamiltonian::*expt_compute_nac_dia_v2)(
          MATRIX& p, const MATRIX& invM, vector<int>& id_) = &nHamiltonian::compute_nac_dia;
      void (nHamiltonian::*expt_compute_nac_dia_v3)(
          MATRIX& p, const MATRIX& invM, int lvl, int split) = &nHamiltonian::compute_nac_dia;
      void (nHamiltonian::*expt_compute_nac_adi_v1)(MATRIX& p, const MATRIX& invM) =
          &nHamiltonian::compute_nac_adi;
      void (nHamiltonian::*expt_compute_nac_adi_v2)(
          MATRIX& p, const MATRIX& invM, vector<int>& id_) = &nHamiltonian::compute_nac_adi;
      void (nHamiltonian::*expt_compute_nac_adi_v3)(
          MATRIX& p, const MATRIX& invM, int lvl, int split) = &nHamiltonian::compute_nac_adi;

      void (nHamiltonian::*expt_compute_hvib_dia_v1)() = &nHamiltonian::compute_hvib_dia;
      void (nHamiltonian::*expt_compute_hvib_dia_v2)(vector<int>& id_) =
          &nHamiltonian::compute_hvib_dia;
      void (nHamiltonian::*expt_compute_hvib_dia_v3)(int lvl) = &nHamiltonian::compute_hvib_dia;
      void (nHamiltonian::*expt_compute_hvib_adi_v1)() = &nHamiltonian::compute_hvib_adi;
      void (nHamiltonian::*expt_compute_hvib_adi_v2)(vector<int>& id_) =
          &nHamiltonian::compute_hvib_adi;
      void (nHamiltonian::*expt_compute_hvib_adi_v3)(int lvl) = &nHamiltonian::compute_hvib_adi;
...
*/
      ...
      complex<double> (nHamiltonian::*expt_Ehrenfest_energy_adi_v2)(
          CMATRIX& ampl_adi, vector<int>& id_) = &nHamiltonian::Ehrenfest_energy_adi;
      ...
      complex<double> (nHamiltonian::*expt_Ehrenfest_energy_dia_v2)(
          CMATRIX& ampl_dia, vector<int>& id_) = &nHamiltonian::Ehrenfest_energy_dia;
      ...
      CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_adi_v1)(
          CMATRIX& ampl_adi, int lvl, int option) = &nHamiltonian::Ehrenfest_forces_adi;
      ...
      CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_dia_v1)(
          CMATRIX& ampl_dia, int lvl, int option) = &nHamiltonian::Ehrenfest_forces_dia;
      ...
      vector<CMATRIX> (nHamiltonian::*expt_Ehrenfest_forces_tens_adi_v2)(
          CMATRIX& ampl_adi, vector<int>& id_) = &nHamiltonian::Ehrenfest_forces_tens_adi;
      ...
      vector<CMATRIX> (nHamiltonian::*expt_Ehrenfest_forces_tens_dia_v2)(
          CMATRIX& ampl_dia, vector<int>& id_) = &nHamiltonian::Ehrenfest_forces_tens_dia;

      complex<double> (nHamiltonian::*expt_QTSH_energy_adi_v1)(CMATRIX& ampl_adi) =
          &nHamiltonian::QTSH_energy_adi;
      complex<double> (nHamiltonian::*expt_QTSH_energy_adi_v2)(
          CMATRIX& ampl_adi, vector<int>& id_) = &nHamiltonian::QTSH_energy_adi;
      complex<double> (nHamiltonian::*expt_QTSH_energy_dia_v1)(CMATRIX& ampl_dia) =
          &nHamiltonian::QTSH_energy_dia;
      complex<double> (nHamiltonian::*expt_QTSH_energy_dia_v2)(
          CMATRIX& ampl_dia, vector<int>& id_) = &nHamiltonian::QTSH_energy_dia;
      ...
      double (nHamiltonian::*expt_kcrpmd_effective_potential_v1)(vector<double>& y_aux_var,
                                                                 const MATRIX& q,
                                                                 const MATRIX& invM,
                                                                 double beta,
                                                                 double eta,
                                                                 ...
                                                                 double c,
                                                                 double d) =
          &nHamiltonian::kcrpmd_effective_potential;
      MATRIX (nHamiltonian::*expt_kcrpmd_effective_force_v1)(vector<double>& y_aux_var,
                                                             const MATRIX& q,
                                                             const MATRIX& invM,
                                                             double beta,
                                                             double eta,
                                                             ...
                                                             double c,
                                                             double d) =
          &nHamiltonian::kcrpmd_effective_force;
      vector<double> (nHamiltonian::*expt_kcrpmd_effective_auxiliary_force_v1)(
          ...
          double b,
          double c,
          double d) = &nHamiltonian::kcrpmd_effective_auxiliary_force;

      void (nHamiltonian::*expt_add_ethd_dia_v1)(const MATRIX& q, const MATRIX& invM, int der_lvl) =
          &nHamiltonian::add_ethd_dia;
      void (nHamiltonian::*expt_add_ethd_adi_v1)(const MATRIX& q, const MATRIX& invM, int der_lvl) =
      ...
      void (nHamiltonian::*expt_add_ethd3_adi_v2)(const MATRIX& q,
                                                  const MATRIX& p,
                                                  const MATRIX& invM,
                                                  double alp,
                                                  double bet,
                                                  int der_lvl) = &nHamiltonian::add_ethd3_adi;
      ...
      class_<nHamiltonianList>("nHamiltonianList").def(vector_indexing_suite<nHamiltonianList>());
...
*/
      ...
      double (*expt_ETHD3_energy_v1)(const MATRIX& q, const MATRIX& invM, double alp) =
          &ETHD3_energy;
      double (*expt_ETHD3_energy_v2)(
          const MATRIX& q, const MATRIX& p, const MATRIX& invM, double alp, double bet) =
          &ETHD3_energy;
      MATRIX (*expt_ETHD3_forces_v1)(const MATRIX& q, const MATRIX& invM, double alp) =
          &ETHD3_forces;
