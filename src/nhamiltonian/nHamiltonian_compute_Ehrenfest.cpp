...
*/
      ...
      if (ovlp_dia_mem_status == 0) {
        cout << "Error in Ehrenfest_energy_dia(): the overlap matrix in the diabatic basis is not allocated \
  but it is needed for the calculations\n";
        exit(0);
      }

      if (ham_dia_mem_status == 0) {
        cout << "Error in Ehrenfest_energy_dia(): the diabatic Hamiltonian matrix is not allocated \
  but it is needed for the calculations\n";
        exit(0);
      }
...
*/
      ...
      if (ham_adi_mem_status == 0) {
        cout << "Error in Ehrenfest_energy_adi(): the adiabatic Hamiltonian matrix is not allocated \
  but it is needed for the calculations\n";
        exit(0);
      }
...
*/
      ...
      if (ham_adi_mem_status == 0) {
        cout << "Error in Ehrenfest_forces_tens_adi(): the adiabatic Hamiltonian matrix is not allocated \
  but it is needed for the calculations\n";
        exit(0);
      }
...
//  not allocated, but they are needed for the calculations\n"; exit(0); }
      ...
      for (int n = 0; n < nnucl; n++) {
        if (d1ham_adi_mem_status[n] == 0) {
          cout << "Error in Ehrenfest_forces_tens_adi(): the derivatives of the Hamiltonian matrix in the \
    adiabatic basis w.r.t. the nuclear DOF "
        ...
        if (dc1_adi_mem_status[n] == 0) {
          cout << "Error in Ehrenfest_forces_tens_adi(): the derivatives couplings matrix in the adiabatic \
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in Ehrenfest_forces_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      ...
      if (ovlp_dia_mem_status == 0) {
        cout << "Error in Ehrenfest_forces_tens_dia(): the overlap matrix in the diabatic basis is not allocated \
  but it is needed for the calculations\n";
        exit(0);
      }

      if (ham_dia_mem_status == 0) {
        cout << "Error in Ehrenfest_forces_tens_dia(): the diabatic Hamiltonian matrix is not allocated \
  but it is needed for the calculations\n";
        exit(0);
      }
...
//  not allocated, but they are needed for the calculations\n"; exit(0); }
      ...
      for (int n = 0; n < nnucl; n++) {
        if (d1ham_dia_mem_status[n] == 0) {
          cout << "Error in Ehrenfest_forces_tens_dia(): the derivatives of the Hamiltonian matrix in the \
      diabatic basis w.r.t. the nuclear DOF "
        ...
        if (dc1_dia_mem_status[n] == 0) {
          cout << "Error in Ehrenfest_forces_tens_dia(): the derivatives couplings matrix in the diabatic \
      basis w.r.t. the nuclear DOF "
               << n << " is not allocated but is needed for the calculations \n";
          exit(0);
        }
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in Ehrenfest_forces_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
