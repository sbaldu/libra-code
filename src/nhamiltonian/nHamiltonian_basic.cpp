    ...
    void nHamiltonian::show_memory_status(vector<int>& id_) {
      ...
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in nHamiltonian::show_memory_status: No Hamiltonian matching the "
                  "requested id\n";
          exit(0);
        }
      } else {
...
*/
      ...
      if (time_overlap_dia_mem_status != 0 && src->time_overlap_dia_mem_status != 0) {
        *time_overlap_dia = *(src->time_overlap_dia);
      }
      if (time_overlap_adi_mem_status != 0 && src->time_overlap_adi_mem_status != 0) {
...
*/
      ...
      if (cum_phase_corr_mem_status == 0) {
        ...
        cout
            << "WARNING in void nHamiltonian::init_cum_phase_corr(): memory is already allocated\n";
      }
    }
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_ovlp_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_dc1_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      ...
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_ham_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_nac_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_hvib_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_d1ham_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_d2ham_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_dc1_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_ham_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_nac_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_hvib_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_d1ham_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_d2ham_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_basis_transform: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_time_overlap_adi: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in get_time_overlap_dia: No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
        vector<int> next(id_.begin() + 1, id_.end());
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in vector<int> nHamiltonian::get_ordering_adi(vector<int>& id_): \
...
*/
      if (cum_phase_corr_mem_status == 0) {
        cout << "ERROR in CMATRIX nHamiltonian::get_cum_phase_corr(): The matrix is not allocated "
                "anywhere\nExiting...\n";
        exit(0);
      }
...
*/
      if (id_.size() == 1) {
        if (id_[0] == id) {
          ...
          cout << "ERROR in CMATRIX nHamiltonian::get_cum_phase_corr(vector<int>& id_):\
                 No Hamiltonian matching the requested id\n";
          exit(0);
        }
      } else {
