...
namespace liblibra {
  ...
  namespace libdata {
    ...
    int DATA::Calculate_Estimators(
        double& Ave, double& Var, double& Sd, double& Se, double& Mse, double& Mae, double& Rmse) {
      int i;
      ave = 0.0;
      var = 0.0;
      mse = 0.0;
      ...
      if (sz > 1) {
        ...
        std::cout
            << "Warning: Data size is less than 2. Can not calculate statistics for such data\n";
      }
