...
*/
      ...
      double (*expt_reorganization_energy_v2)(vector<double>& omega_nm, vector<double>& req_nm) =
          &reorganization_energy;
      double (*expt_diabat_crossing_v1)(double dE, double Er, double y0) = &diabat_crossing;
      double (*expt_coupling_Condon_v1)(double gamma, double dE, double Er, double y0) =
          &coupling_Condon;
      double (*expt_coupling_non_Condon_v1)(
          double y, double gamma, double dE, double Er, double y0) = &coupling_non_Condon;
      vector<double> (*expt_normal_modes_v1)(
          vector<double>& omega, vector<double>& coeff, MATRIX& T) = &normal_modes;
      vector<double> (*expt_compute_req_v1)(
          vector<double>& omega, vector<double>& coeff, double y0, MATRIX& T) = &compute_req;
      vector<double> (*expt_compute_TT_scaled_v1)(MATRIX& T, double scl) = &compute_TT_scaled;
      double (*expt_LVC2GOA_dE_v1)(
          double E0, double E1, vector<double>& omega_nm, vector<double>& d1, vector<double>& d2) =
          &LVC2GOA_dE;
      vector<double> (*expt_LVC2GOA_req_v1)(
          vector<double>& omega_nm, vector<double>& d1, vector<double>& d2) = &LVC2GOA_req;
      ...
      complex<double> (*expt_Integrand_NE_exact_v1)(double tp,
                                                    double tau,
                                                    double omega_DA,
                                                    double omega,
                                                    double req,
                                                    double shift,
                                                    double beta) = &Integrand_NE_exact;
      complex<double> (*expt_Linear_NE_exact_v1)(
          double tp, double tau, double gamma, double omega, double req, double shift, double beta) =
          &Linear_NE_exact;
      complex<double> (*expt_ACF_NE_exact_v1)(double tp,
                                              double tau,
                                              double omega_DA,
                                              double V,
      ...
      complex<double> (*expt_Integrand_NE_LSC_v1)(double tp,
                                                  double tau,
                                                  double omega_DA,
                                                  double omega,
                                                  double req,
                                                  double shift,
                                                  double beta) = &Integrand_NE_LSC;
      complex<double> (*expt_Linear_NE_LSC_v1)(
          double tp, double tau, double gamma, double omega, double req, double shift, double beta) =
          &Linear_NE_LSC;
      complex<double> (*expt_ACF_NE_LSC_v1)(double tp,
                                            double tau,
                                            double omega_DA,
                                            double V,
                                            vector<double>& omega_nm,
      ...
      complex<double> (*expt_Integrand_NE_CAV_v1)(double tp,
                                                  double tau,
                                                  double omega_DA,
                                                  double omega,
                                                  double req,
                                                  double shift,
                                                  double beta) = &Integrand_NE_CAV;
      complex<double> (*expt_Linear_NE_CAV_v1)(
          double tp, double tau, double gamma, double omega, double req, double shift, double beta) =
          &Linear_NE_CAV;
      complex<double> (*expt_ACF_NE_CAV_v1)(double tp,
                                            double tau,
                                            double omega_DA,
                                            double V,
                                            vector<double>& omega_nm,
      ...
      complex<double> (*expt_Integrand_NE_CD_v1)(double tp,
                                                 double tau,
                                                 double omega_DA,
                                                 double omega,
                                                 double req,
                                                 double shift,
                                                 double beta) = &Integrand_NE_CD;
      complex<double> (*expt_Linear_NE_CD_v1)(
          double tp, double tau, double gamma, double omega, double req, double shift, double beta) =
          &Linear_NE_CD;
      complex<double> (*expt_ACF_NE_CD_v1)(double tp,
                                           double tau,
                                           double omega_DA,
                                           double V,
                                           vector<double>& omega_nm,
      ...
      complex<double> (*expt_Integrand_NE_W0_v1)(double tp,
                                                 double tau,
                                                 double omega_DA,
                                                 double omega,
                                                 double req,
                                                 double shift,
                                                 double beta) = &Integrand_NE_W0;
      complex<double> (*expt_Linear_NE_W0_v1)(
          double tp, double tau, double gamma, double omega, double req, double shift, double beta) =
          &Linear_NE_W0;
      complex<double> (*expt_ACF_NE_W0_v1)(double tp,
                                           double tau,
                                           double omega_DA,
                                           double V,
                                           vector<double>& omega_nm,
      ...
      complex<double> (*expt_Integrand_NE_C0_v1)(double tp,
                                                 double tau,
                                                 double omega_DA,
                                                 double omega,
                                                 double req,
                                                 double shift,
                                                 double beta) = &Integrand_NE_C0;
      complex<double> (*expt_Linear_NE_C0_v1)(
          double tp, double tau, double gamma, double omega, double req, double shift, double beta) =
          &Linear_NE_C0;
      complex<double> (*expt_ACF_NE_C0_v1)(double tp,
                                           double tau,
                                           double omega_DA,
                                           double V,
                                           vector<double>& omega_nm,
      ...
      double (*expt_NEFGRL_rate_v1)(double t,
                                    double omega_DA,
                                    double V,
                                    vector<double>& omega_nm,
                                    vector<double>& gamma_nm,
