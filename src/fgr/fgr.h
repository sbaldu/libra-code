...
namespace liblibra {
  ...
  namespace libfgr {
    ...
    double S_omega_gaussian(double omega,
                            double eta,
                            double sigma,
                            double omega_op);  //gaussian spectral density
    /*
...
*/
    ...
    complex<double> Integrand_NE_exact(
        double tp, double tau, double omega_DA, double omega, double req, double shift, double beta);
    ...
    complex<double> Integrand_NE_LSC(
        double tp, double tau, double omega_DA, double omega, double req, double shift, double beta);
    ...
    complex<double> Integrand_NE_CAV(
        double tp, double tau, double omega_DA, double omega, double req, double shift, double beta);
    ...
    complex<double> Integrand_NE_CD(
        double tp, double tau, double omega_DA, double omega, double req, double shift, double beta);
    ...
    complex<double> Integrand_NE_W0(
        double tp, double tau, double omega_DA, double omega, double req, double shift, double beta);
    ...
    complex<double> Integrand_NE_C0(
        double tp, double tau, double omega_DA, double omega, double req, double shift, double beta);
