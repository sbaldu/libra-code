...
*/
      ...
      void (Hamiltonian_Atomistic::*expt_set_q_v2)(boost::python::list) =
          &Hamiltonian_Atomistic::set_q;
      void (Hamiltonian_Atomistic::*expt_set_v_v1)(vector<double>&) = &Hamiltonian_Atomistic::set_v;
      void (Hamiltonian_Atomistic::*expt_set_v_v2)(boost::python::list) =
          &Hamiltonian_Atomistic::set_v;

      bool (Hamiltonian_Atomistic::*expt_is_active_v1a)(Atom&, Atom&) =
          &Hamiltonian_Atomistic::is_active;
      bool (Hamiltonian_Atomistic::*expt_is_active_v2a)(Atom&, Atom&, Atom&) =
          &Hamiltonian_Atomistic::is_active;
      bool (Hamiltonian_Atomistic::*expt_is_active_v3a)(Atom&, Atom&, Atom&, Atom&) =
          &Hamiltonian_Atomistic::is_active;
...
*/
          ...
          .def("set_atom_interactions_for_atoms",
               &Hamiltonian_Atomistic::set_atom_interactions_for_atoms)
          .def("set_group_interactions_for_atoms",
               &Hamiltonian_Atomistic::set_group_interactions_for_atoms)

          .def("set_interactions_for_atoms", &Hamiltonian_Atomistic::set_interactions_for_atoms)
          .def("set_interactions_for_fragments",
               &Hamiltonian_Atomistic::set_interactions_for_fragments)
