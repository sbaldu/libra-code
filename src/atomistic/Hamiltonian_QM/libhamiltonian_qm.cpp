...
*/
        ...
        //----------- INDO -----------------
        vector<int> (*expt_compute_sorb_indices_v1)(int sz,
                                                    vector<AO>& basis_ao,
                                                    vector<vector<int> >& atom_to_ao_map,
                                                    vector<int>& ao_to_atom_map) =
            &compute_sorb_indices;

        void (*expt_compute_indo_core_parameters_v1)(System& syst,
                                                     vector<AO>& basis_ao,
                                                     ...
                                                     int b,
                                                     double& eri,
                                                     double& V_AB) = &compute_indo_core_parameters;

        void (*expt_compute_indo_core_parameters_derivs_v1)(System& syst,
                                                            vector<AO>& basis_ao,
                                                            Model_Parameters& modprms,
                                                            vector<vector<int> >& atom_to_ao_map,
                                                            vector<int>& ao_to_atom_map,
        ...
        void (*expt_indo_core_parameters_v1)(System& syst,
                                             vector<AO>& basis_ao,
                                             Model_Parameters& modprms,
                                             vector<vector<int> >& atom_to_ao_map,
                                             vector<int>& ao_to_atom_map,
                                             int opt,
                                             int DF) = &indo_core_parameters;

        void (*expt_Hamiltonian_core_indo_v1)(System& syst,
                                              vector<AO>& basis_ao,
                                              ...
                                              MATRIX& Hao,
                                              MATRIX& Sao,
                                              int DF) = &Hamiltonian_core_indo;

        void (*expt_Hamiltonian_core_deriv_indo_v1)(System& syst,
                                                    vector<AO>& basis_ao,
                                                    Control_Parameters& prms,
                                                    Model_Parameters& modprms,
                                                    vector<vector<int> >& atom_to_ao_map,
                                                    ...
                                                    MATRIX& dSao_dx,
                                                    MATRIX& dSao_dy,
                                                    MATRIX& dSao_dz) = &Hamiltonian_core_deriv_indo;

        void (*expt_get_integrals_v1)(int i,
                                      int j,
                                      vector<AO>& basis_ao,
                                      double eri_aa,
                                      double G1,
                                      double F2,
                                      double& ii_jj,
                                      double& ij_ij) = &get_integrals;

        void (*expt_Hamiltonian_Fock_indo_v1)(Electronic_Structure& el,
                                              System& syst,
                                              vector<AO>& basis_ao,
                                              Control_Parameters& prms,
                                              Model_Parameters& modprms,
                                              vector<vector<int> >& atom_to_ao_map,
                                              vector<int>& ao_to_atom_map) = &Hamiltonian_Fock_indo;

        void (*expt_Hamiltonian_Fock_derivs_indo_v1)(Electronic_Structure& el,
                                                     System& syst,
                                                     vector<AO>& basis_ao,
                                                     Control_Parameters& prms,
                                                     Model_Parameters& modprms,
        ...
        void (*expt_Hamiltonian_core_eht_v1)(System& syst,
                                             vector<AO>& basis_ao,
                                             Control_Parameters& prms,
                                             Model_Parameters& modprms,
                                             vector<vector<int> >& atom_to_ao_map,
                                             ...
                                             MATRIX& Hao,
                                             MATRIX& Sao,
                                             int DF) = &Hamiltonian_core_eht;

        void (*expt_Hamiltonian_core_deriv_eht_v1)(System& syst,
                                                   vector<AO>& basis_ao,
                                                   Control_Parameters& prms,
                                                   Model_Parameters& modprms,
                                                   vector<vector<int> >& atom_to_ao_map,
                                                   ...
                                                   MATRIX& dSao_dx,
                                                   MATRIX& dSao_dy,
                                                   MATRIX& dSao_dz) = &Hamiltonian_core_deriv_eht;

        void (*expt_Hamiltonian_Fock_eht_v1)(Electronic_Structure& el,
                                             System& syst,
                                             vector<AO>& basis_ao,
                                             Control_Parameters& prms,
                                             Model_Parameters& modprms,
                                             vector<vector<int> >& atom_to_ao_map,
                                             vector<int>& ao_to_atom_map) = &Hamiltonian_Fock_eht;
        ...
        //----------- HF -----------------
        void (*expt_Hamiltonian_core_hf_v1)(System& syst,
                                            vector<AO>& basis_ao,
                                            Control_Parameters& prms,
                                            Model_Parameters& modprms,
                                            vector<vector<int> >& atom_to_ao_map,
                                            ...
                                            MATRIX& Hao,
                                            MATRIX& Sao,
                                            int DF) = &Hamiltonian_core_hf;

        void (*expt_Hamiltonian_Fock_hf_v1)(Electronic_Structure& el,
                                            System& syst,
                                            vector<AO>& basis_ao,
                                            Control_Parameters& prms,
                                            Model_Parameters& modprms,
                                            vector<vector<int> >& atom_to_ao_map,
                                            vector<int>& ao_to_atom_map) = &Hamiltonian_Fock_hf;

        def("Hamiltonian_core_hf", expt_Hamiltonian_core_hf_v1);
        def("Hamiltonian_Fock_hf", expt_Hamiltonian_Fock_hf_v1);

        //----------- Hamiltonian_QM -----------------
        void (*expt_Hamiltonian_core_v1)(System& syst,
                                         vector<AO>& basis_ao,
                                         Control_Parameters& prms,
                                         Model_Parameters& modprms,
                                         vector<vector<int> >& atom_to_ao_map,
                                         ...
                                         MATRIX& Hao,
                                         MATRIX& Sao,
                                         int DF) = &Hamiltonian_core;

        void (*expt_Hamiltonian_Fock_v1)(Electronic_Structure& el,
                                         System& syst,
                                         vector<AO>& basis_ao,
                                         Control_Parameters& prms,
                                         Model_Parameters& modprms,
                                         vector<vector<int> >& atom_to_ao_map,
                                         vector<int>& ao_to_atom_map) = &Hamiltonian_Fock;

        double (*expt_energy_and_forces_v1)(Electronic_Structure& el,
                                            System& syst,
                                            vector<AO>& basis_ao,
                                            Control_Parameters& prms,
                                            Model_Parameters& modprms,
                                            vector<vector<int> >& atom_to_ao_map,
                                            vector<int>& ao_to_atom_map) = &energy_and_forces;

        void (*expt_derivative_couplings_v1)(Electronic_Structure& el,
                                             System& syst,
                                             vector<AO>& basis_ao,
                                             Control_Parameters& prms,
                                             Model_Parameters& modprms,
                                             ...
                                             MATRIX& Dmo_b_x,
                                             MATRIX& Dmo_b_y,
                                             MATRIX& Dmo_b_z) = &derivative_couplings;

        void (*expt_derivative_couplings_v2)(Electronic_Structure& el,
                                             System& syst,
                                             vector<AO>& basis_ao,
                                             Control_Parameters& prms,
                                             Model_Parameters& modprms,
                                             ...
                                             MATRIX& dEb_dx,
                                             MATRIX& dEb_dy,
                                             MATRIX& dEb_dz) = &derivative_couplings1;

        void (*expt_derivative_couplings_v3)(Electronic_Structure& el,
                                             System& syst,
                                             vector<AO>& basis_ao,
                                             Control_Parameters& prms,
                                             Model_Parameters& modprms,
                                             ...
                                             MATRIX& Dmo_b_x,
                                             MATRIX& Dmo_b_y,
                                             MATRIX& Dmo_b_z) = &derivative_couplings1;
        ...
        //--------------- SCF.*** ------------------------------------
        double (*expt_scf_v1)(Electronic_Structure& el,
                              System& syst,
                              vector<AO>& basis_ao,
                              Control_Parameters& prms,
                              Model_Parameters& modprms,
        ...
        double (*expt_scf_none_v1)(Electronic_Structure& el,
                                   System& syst,
                                   vector<AO>& basis_ao,
                                   Control_Parameters& prms,
                                   Model_Parameters& modprms,
        ...
        double (*expt_scf_oda_v1)(Electronic_Structure& el,
                                  System& syst,
                                  vector<AO>& basis_ao,
                                  Control_Parameters& prms,
                                  Model_Parameters& modprms,
        ...
        double (*expt_scf_oda_disk_v1)(Electronic_Structure& el,
                                       System& syst,
                                       vector<AO>& basis_ao,
                                       Control_Parameters& prms,
                                       Model_Parameters& modprms,
