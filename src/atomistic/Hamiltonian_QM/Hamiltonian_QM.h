...
*/
      ...
      public:
        ...
        void operator=(
            const listHamiltonian_QM&);  ///< Copying one listHamiltonian_QM into the other one

        int Nelec;  ///< The number of electrons in this sub-system
        int Norb;   ///< The total number of orbitals in this sub-system
        Control_Parameters
            prms;  ///< Control parameters defining how to perform calculations for this sub-system
        ...
        //============ Excited states ================
        vector<excitation>
            basis_ex;  ///< Excitations for this sub-system -  may be the same as in prms, but may be different

        // Methods
        void init(std::string ctrl_filename, System& syst);
        double compute_scf(System& syst);

        void get_parameters_from_file(std::string filename) {
          libcontrol_parameters::get_parameters_from_file(filename, prms);
        }
...
*/
      ...
      typedef std::vector<listHamiltonian_QM>
          listHamiltonian_QMList;  ///< Data type that holds a vector of listHamiltonian_QM objects
      typedef std::vector<vector<listHamiltonian_QM> >
          listHamiltonian_QMMap;  ///< Data type that holds the table (grid) of listHamiltonian_QM objects
