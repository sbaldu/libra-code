...
*/
  ...
  */
          ...
          Fao_alp = NULL;
          Fao_bet = NULL;
          dFao_alp_dP_alp = NULL;
          dFao_alp_dP_bet = NULL;
          dFao_bet_dP_alp = NULL;
          dFao_bet_dP_bet = NULL;
          E_alp = NULL;
          E_bet = NULL;
        }
  ...
  */
        ...
        Electronic_Structure(
            Electronic_Structure*);  ///< Constructor from the address of the other existing object
  ...
  */
          ...
          delete Fao_alp;
          delete Fao_bet;
          delete dFao_alp_dP_alp;
          delete dFao_alp_dP_bet;
          delete dFao_bet_dP_alp;
          delete dFao_bet_dP_bet;
          delete E_alp;
          delete E_bet;
        ...
        vector<pair<int, double> >
            bands_alp;  ///< orbital indices and orbital energies, alpha-channel
        vector<pair<int, double> > bands_bet;  ///< orbital indices and orbital energies, beta-channel
        vector<pair<int, double> >
            occ_alp;  ///< orbital indices and orbital occupation numbers, alpha-channel
        vector<pair<int, double> >
            occ_bet;  ///< orbital indices and orbital occupation numbers, beta-channel
        ...
        // Corrections:
        MATRIX*
            dFao_alp_dP_alp;  ///< derivative of the Fock matrix (alpha component) w.r.t. alpha component of density matrix
        MATRIX*
            dFao_alp_dP_bet;  ///< derivative of the Fock matrix (alpha component) w.r.t. beta component of density matrix
        MATRIX*
            dFao_bet_dP_alp;  ///< derivative of the Fock matrix (beta component) w.r.t. alpha component of density matrix
        MATRIX*
            dFao_bet_dP_bet;  ///< derivative of the Fock matrix (beta component) w.r.t. beta component of density matrix
        ...
        vector<double>
            Mull_orb_pop_gross;  ///< Gross Mulliken populations for all (molecular) orbitals
      ...
      // Electronic.cpp
      int init_numbers(
          vector<int>&, Electronic_Structure*, vector<AO>&, Model_Parameters&, System&, double);
