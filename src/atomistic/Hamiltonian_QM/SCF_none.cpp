...
*/
        ...
        MATRIX* P_alp_old;
        P_alp_old = new MATRIX(Norb, Norb);
        MATRIX* P_bet_old;
        P_bet_old = new MATRIX(Norb, Norb);
        ...
        double E = (energy_elec(el->P_alp, el->Hao, el->Fao_alp) +
                    energy_elec(el->P_bet, el->Hao, el->Fao_bet));
        ...
        *P_bet_old = *el->P_bet;
        ...
        while (run) {
          ...
          *el->P = *el->P_alp + *el->P_bet;
          ...
          d_err =
              fabs((*el->P_alp - *P_alp_old).max_elt()) + fabs((*el->P_bet - *P_bet_old).max_elt());

          *P_alp_old = *el->P_alp;
          *P_bet_old = *el->P_bet;

          E_old = E;
          E = (energy_elec(el->P_alp, el->Hao, el->Fao_alp) +
               energy_elec(el->P_bet, el->Hao, el->Fao_bet));

          e_err = fabs(E_old - E);

          cout << "Iteration " << i << " e_err = " << e_err << " d_err = " << d_err
               << " E_el = " << E << endl;
