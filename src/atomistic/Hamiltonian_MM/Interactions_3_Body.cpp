...
namespace liblibra {
  ...
  namespace libatomistic {
    ...
    namespace libhamiltonian_mm {
      ...
      void Interaction_3_Body::set_coords(VECTOR* r1_, VECTOR* r2_, VECTOR* r3_) {
        r[0] = r1_;
        r[1] = r2_;
        r[2] = r3_;
      }
      ...
      void Interaction_3_Body::set_transl(VECTOR* t1_, VECTOR* t2_, VECTOR* t3_) {
        t[0] = t1_;
        t[1] = t2_;
        t[2] = t3_;
      }
      ...
      void Interaction_3_Body::set_forces(VECTOR* f1_, VECTOR* f2_, VECTOR* f3_) {
        f[0] = f1_;
        f[1] = f2_;
        f[2] = f3_;
      }
      ...
      void Interaction_3_Body::set_charges(double* q1_, double* q2_, double* q3_) {
        q[0] = q1_;
        q[1] = q2_;
        q[2] = q3_;
      }
...
*/
        if (is_active) {
          ...
          if (t[0] == NULL || t[1] == NULL || t[2] == NULL) {
            ...
            cout << "Warning in Angle_Interaction::compute() : translations are not set. Not using "
                    "them\n";
            r1 = *r[0];
            r2 = *r[1];
            r3 = *r[2];
          ...
          if (functional == 0) {
            energy += Angle_Harmonic(r1, r2, r3, f1, f2, f3, k_theta, theta_0);
          } else if (functional == 1) {
            energy += Angle_Fourier(r1, r2, r3, f1, f2, f3, k_theta, C0, C1, C2, coordination);
          } else if (functional == 2) {
            energy += Angle_Fourier_General(r1, r2, r3, f1, f2, f3, k_theta, C0, C1, C2);
          } else if (functional == 3) {
            energy += Angle_Fourier_Special(r1, r2, r3, f1, f2, f3, k_theta, coordination);
          } else if (functional == 4) {
            energy +=
                Angle_Harmonic_Cos(r1, r2, r3, f1, f2, f3, k_theta, cos_theta_0, coordination);
          } else if (functional == 5) {
            energy += Angle_Harmonic_Cos_General(r1, r2, r3, f1, f2, f3, k_theta, cos_theta_0);
          } else if (functional == 6) {
            energy += Angle_Cubic(r1, r2, r3, f1, f2, f3, k_theta, theta_0);
          }
