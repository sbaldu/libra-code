...
*/
        ...
        void (Interaction_N_Body::*expt_set_coords_v1)(VECTOR& r_, int indx) =
            &Interaction_N_Body::set_coords;
        void (Interaction_N_Body::*expt_set_coords_v2)(vector<VECTOR>& r_, vector<int>& indxs_) =
            &Interaction_N_Body::set_coords;

        void (Interaction_N_Body::*expt_set_transl_v1)(VECTOR& r_, int indx) =
            &Interaction_N_Body::set_transl;
        void (Interaction_N_Body::*expt_set_transl_v2)(vector<VECTOR>& t_, vector<int>& indxs_) =
            &Interaction_N_Body::set_transl;

        void (Interaction_N_Body::*expt_set_forces_v1)(VECTOR& r_, int indx) =
            &Interaction_N_Body::set_forces;
        void (Interaction_N_Body::*expt_set_forces_v2)(vector<VECTOR>& r_, vector<int>& indxs_) =
            &Interaction_N_Body::set_forces;

        void (Interaction_N_Body::*expt_set_charges_v1)(double& q_, int indx) =
            &Interaction_N_Body::set_charges;
        void (Interaction_N_Body::*expt_set_charges_v2)(vector<double>& q_, vector<int>& indxs_) =
            &Interaction_N_Body::set_charges;

        void (Interaction_N_Body::*expt_set_hessian_v1)(MATRIX& hess_, vector<int>& hess_stenc_) =
            &Interaction_N_Body::set_hessian;
        void (Interaction_N_Body::*expt_set_functional_v1)(std::string f) =
            &Interaction_N_Body::set_functional;
        ...
        void (Interaction_2_Body::*expt_set_coords_v2_2b)(VECTOR& r1_, VECTOR& r2_) =
            &Interaction_2_Body::set_coords;
        void (Interaction_2_Body::*expt_set_transl_v2_2b)(VECTOR& t1_, VECTOR& t2_) =
            &Interaction_2_Body::set_transl;
        void (Interaction_2_Body::*expt_set_forces_v2_2b)(VECTOR& f1_, VECTOR& f2_) =
            &Interaction_2_Body::set_forces;
        void (Interaction_2_Body::*expt_set_charges_v2_2b)(double& q1_, double& q2_) =
            &Interaction_2_Body::set_charges;
        ...
        void (Bond_Interaction::*expt_set_params_v1_2b)(boost::python::dict) =
            &Bond_Interaction::set_params;
        void (VdW_Interaction::*expt_set_params_v1_2v)(boost::python::dict) =
            &VdW_Interaction::set_params;
        void (Elec_Interaction::*expt_set_params_v1_2e)(boost::python::dict) =
            &Elec_Interaction::set_params;

        void (Bond_Interaction::*expt_compute_v1_2b)() = &Bond_Interaction::compute;
        void (VdW_Interaction::*expt_compute_v1_2v)(double Ron, double Roff) =
            &VdW_Interaction::compute;
        void (VdW_Interaction::*expt_compute_v2_2v)() = &VdW_Interaction::compute;
        void (Elec_Interaction::*expt_compute_v1_2e)(double Ron, double Roff) =
            &Elec_Interaction::compute;
        ...
        void (Interaction_3_Body::*expt_set_coords_v1_3b)(VECTOR& r1_, VECTOR& r2_, VECTOR& r3_) =
            &Interaction_3_Body::set_coords;
        void (Interaction_3_Body::*expt_set_transl_v1_3b)(VECTOR& t1_, VECTOR& t2_, VECTOR& t3_) =
            &Interaction_3_Body::set_transl;
        void (Interaction_3_Body::*expt_set_forces_v1_3b)(VECTOR& f1_, VECTOR& f2_, VECTOR& f3_) =
            &Interaction_3_Body::set_forces;
        void (Interaction_3_Body::*expt_set_charges_v1_3b)(double& q1_, double& q2_, double& q3_) =
            &Interaction_3_Body::set_charges;
        ...
        void (Interaction_4_Body::*expt_set_coords_v1_4b)(
            VECTOR& r1_, VECTOR& r2_, VECTOR& r3_, VECTOR& r4_) = &Interaction_4_Body::set_coords;
        void (Interaction_4_Body::*expt_set_transl_v1_4b)(
            VECTOR& t1_, VECTOR& t2_, VECTOR& t3_, VECTOR& t4_) = &Interaction_4_Body::set_transl;
        void (Interaction_4_Body::*expt_set_forces_v1_4b)(
            VECTOR& f1_, VECTOR& f2_, VECTOR& f3_, VECTOR& f4_) = &Interaction_4_Body::set_forces;
        void (Interaction_4_Body::*expt_set_charges_v1_4b)(
            double& q1_, double& q2_, double& q3_, double& q4_) = &Interaction_4_Body::set_charges;
        ...
        bool (listHamiltonian_MM::*expt_is_active_v1)(Atom&, Atom&) =
            &listHamiltonian_MM::is_active;
        bool (listHamiltonian_MM::*expt_is_active_v2)(Atom&, Atom&, Atom&) =
            &listHamiltonian_MM::is_active;
        bool (listHamiltonian_MM::*expt_is_active_v3)(Atom&, Atom&, Atom&, Atom&) =
            &listHamiltonian_MM::is_active;
        ...
        class_<Hamiltonian_MM>("Hamiltonian_MM", init<>())
            ...
            .def("set_interaction_type_and_functional",
                 &Hamiltonian_MM::set_interaction_type_and_functional)
            .def("activate", &Hamiltonian_MM::activate)
        ...
        class_<listHamiltonian_MM>("listHamiltonian_MM", init<>())
            ...
            .def("set_atom_interactions_for_atoms",
                 &listHamiltonian_MM::set_atom_interactions_for_atoms)
            .def("set_group_interactions_for_atoms",
                 &listHamiltonian_MM::set_group_interactions_for_atoms)

            .def("set_interactions_for_atoms", &listHamiltonian_MM::set_interactions_for_atoms)
            .def("set_interactions_for_fragments",
                 &listHamiltonian_MM::set_interactions_for_fragments)
