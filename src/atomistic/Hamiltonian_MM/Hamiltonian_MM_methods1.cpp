...
*/
        ...
        if (t == "bond") {
          ...
          if (f == "Harmonic") {
            ...
            std::cout << "Warning: Bond functional " << f << " is not implemented\n";
          }
        } else if (t == "angle") {
          int_type = 1;
          is_int_type = 1;
          if (f == "Harmonic") {
            ...
            functional = 1;
            is_functional = 1;
          } else if (f == "Fourier_General") {
            functional = 2;
            is_functional = 1;
          } else if (f == "Fourier_Special") {
            functional = 3;
            is_functional = 1;
          } else if (f == "Harmonic_Cos") {
            functional = 4;
            is_functional = 1;
          } else if (f == "Harmonic_Cos_General") {
            functional = 5;
            is_functional = 1;
          } else if (f == "Cubic") {
            functional = 6;
            ...
            std::cout << "Warning: Angle functional " << f << " is not implemented\n";
          }
        } else if (t == "dihedral") {
          int_type = 2;
          is_int_type = 1;
          if ((f == "General0") || (f == "General1") || (f == "General2") || (f == "General3")) {
            functional = 0;
            is_functional = 1;
          } else if ((f == "Fourier0") || (f == "Fourier1")) {
            functional = 1;
            is_functional = 1;
          } else {
            std::cout << "Warning: Dihedral/Torsion functional " << f << " is not implemented\n";
          }
        } else if (t == "oop") {
          int_type = 3;
          is_int_type = 1;
          if (f == "Fourier") {
            ...
            std::cout << "Warning: Oop functional " << f << " is not implemented\n";
          }
        } else if (t == "vdw") {
          int_type = 4;
          is_int_type = 1;
          if (f == "LJ") {
            ...
            std::cout << "Warning: Vdw functional " << f << " is not implemented\n";
          }
        } else if (t == "elec") {
          int_type = 5;
          is_int_type = 1;
          if (f == "Coulomb") {
            ...
            std::cout << "Warning: Elec functional " << f << " is not implemented\n";
          }
        } else if (t == "mb") {
          int_type = 6;
          is_int_type = 1;
          if (f == "Ewald_3D") {
            ...
            functional = 2;
            is_functional = 1;
          } else if (f == "LJ_Coulomb") {
            functional = 3;
            is_functional = 1;
          } else {
            std::cout << "Warning: Many-body potential " << f << " is not implemented\n";
          }
        } else if (t == "cg") {
          int_type = 7;
          is_int_type = 1;
          if (f == "Gay-Berne") {
            ...
            std::cout << "Warning: Coarse-grain (fragment-fragment) potential " << f
                      << " is not implemented\n";
          }
        } else if (t == "mb_excl") {
          int_type = 8;
          ...
          if (f == "vdw_LJ1") {
            ...
            std::cout << "Warning: Many-body exclusion potential " << f << " is not implemented\n";
          }
        }
      ...
      void Hamiltonian_MM::set_2a_interaction(std::string t,
                                              std::string f,
                                              int id1,
                                              int id2,
                                              VECTOR& r1,
...
*/
        ...
        if (int_type == 0) {  // bond
          if (data_bond == NULL) {
            data_bond = new bond_interaction;
          }
          // Set up parameters
          for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
            if (it->first == "K") {
              data_bond->K = it->second;
            } else if (it->first == "D") {
              data_bond->D = it->second;
            } else if (it->first == "r0") {
              data_bond->r0 = it->second;
            } else if (it->first == "alpha") {
              data_bond->alpha = it->second;
            }
          }
          data_bond->id1 = id1;
          data_bond->id2 = id2;
          ...
          if (data_vdw == NULL) {
            data_vdw = new vdw_interaction;
          }
          // Set up parameters
          for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
            if (it->first == "sigma") {
              data_vdw->sigma = it->second;
            } else if (it->first == "epsilon") {
              data_vdw->epsilon = it->second;
            } else if (it->first == "D") {
              data_vdw->D = it->second;
            } else if (it->first == "r0") {
              data_vdw->r0 = it->second;
            } else if (it->first == "alpha") {
              data_vdw->alpha = it->second;
            } else if (it->first == "scale") {
              data_vdw->scale = it->second;
            } else if (it->first == "R_on") {
              data_vdw->R_on = it->second;
            } else if (it->first == "R_off") {
              data_vdw->R_off = it->second;
            } else if (it->first == "R_on2") {
              data_vdw->R_on2 = it->second;
            } else if (it->first == "R_off2") {
              data_vdw->R_off2 = it->second;
            } else if (it->first == "is_cutoff") {
              data_vdw->is_cutoff = it->second;
            } else if (it->first == "time") {
              data_vdw->time = it->second;
            }
          }
          data_vdw->id1 = id1;
          data_vdw->id2 = id2;
          ...
          data_vdw->r1_old = r1;
          data_vdw->r2_old = r2;
          data_vdw->displr1_2 = &dr1_2;
          data_vdw->displr2_2 = &dr2_2;
          data_vdw->displT_2 = &dT_2;

        }  // vdw
        else if (int_type == 5) {  // elec
          if (data_elec == NULL) {
            data_elec = new elec_interaction;
          }
          // Set up parameters
          for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
            if (it->first == "q1") {
              data_elec->q1 = it->second;
            } else if (it->first == "q2") {
              data_elec->q2 = it->second;
            } else if (it->first == "xi1") {
              data_elec->xi1 = it->second;
            } else if (it->first == "xi2") {
              data_elec->xi2 = it->second;
            } else if (it->first == "eps") {
              data_elec->eps = it->second;
            } else if (it->first == "J") {
              data_elec->J = it->second;
            } else if (it->first == "delta") {
              data_elec->delta = it->second;
            } else if (it->first == "scale") {
              data_elec->scale = it->second;
            } else if (it->first == "R_on") {
              data_elec->R_on = it->second;
            } else if (it->first == "R_off") {
              data_elec->R_off = it->second;
            } else if (it->first == "R_on2") {
              data_elec->R_on2 = it->second;
            } else if (it->first == "R_off2") {
              data_elec->R_off2 = it->second;
            } else if (it->first == "is_cutoff") {
              data_elec->is_cutoff = it->second;
            }
          }
          data_elec->id1 = id1;
          data_elec->id2 = id2;
      ...
      void Hamiltonian_MM::set_3a_interaction(std::string t,
                                              std::string f,
                                              int id1,
                                              int id2,
                                              int id3,
...
*/
        ...
        if (int_type == 1) {  // angle
          if (data_angle == NULL) {
            data_angle = new angle_interaction;
          }
          // Set up parameters
          for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
            if (it->first == "k_theta") {
              data_angle->k_theta = it->second;
            } else if (it->first == "theta_0") {
              data_angle->theta_0 = it->second;
            } else if (it->first == "cos_theta_0") {
              data_angle->cos_theta_0 = it->second;
            } else if (it->first == "C0") {
              data_angle->C0 = it->second;
            } else if (it->first == "C1") {
              data_angle->C1 = it->second;
            } else if (it->first == "C2") {
              data_angle->C2 = it->second;
            } else if (it->first == "coordination") {
              data_angle->coordination = (int)it->second;
            }
          }
          data_angle->id1 = id1;
          data_angle->id2 = id2;
      ...
      void Hamiltonian_MM::set_4a_interaction(std::string t,
                                              std::string f,
                                              int id1,
                                              int id2,
                                              int id3,
...
*/
        ...
        if (int_type == 2) {
          if (data_dihedral == NULL) {
            data_dihedral = new dihedral_interaction;
          }
          // Set up parameters
          for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
            if (it->first == "Vphi") {
              data_dihedral->Vphi = it->second;
            } else if (it->first == "phi0") {
              data_dihedral->phi0 = it->second;
            } else if (it->first == "Vphi1") {
              data_dihedral->Vphi1 = it->second;
            } else if (it->first == "Vphi2") {
              data_dihedral->Vphi2 = it->second;
            } else if (it->first == "Vphi3") {
              data_dihedral->Vphi3 = it->second;
            } else if (it->first == "opt") {
              data_dihedral->opt = (int)it->second;
            } else if (it->first == "n") {
              data_dihedral->n = (int)it->second;
            }
          }
          if (f == "General0") {
            data_dihedral->opt = 0;
          ...
          data_dihedral->id1 = id1;
          data_dihedral->id2 = id2;
          data_dihedral->id3 = id3;
          data_dihedral->id4 = id4;
          data_dihedral->r1 = &r1;
          data_dihedral->r2 = &r2;
          data_dihedral->r3 = &r3;
          data_dihedral->r4 = &r4;
          ...
          if (data_oop == NULL) {
            data_oop = new oop_interaction;
          }
          // Set up parameters
          for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
            if (it->first == "K") {
              data_oop->K = it->second;
            } else if (it->first == "xi_0") {
              data_oop->xi_0 = it->second;
            } else if (it->first == "C0") {
              data_oop->C0 = it->second;
            } else if (it->first == "C1") {
              data_oop->C1 = it->second;
            } else if (it->first == "C2") {
              data_oop->C2 = it->second;
            } else if (it->first == "opt") {
              data_oop->opt = (int)it->second;
            }
          }
          data_oop->id1 = id1;
          data_oop->id2 = id2;
      ...
      void Hamiltonian_MM::set_mb_interaction(std::string t,
                                              std::string p,
                                              int sz,
                                              int* id,
                                              VECTOR** r,
...
*/
        ...
        for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
          if (it->first == "R_on") {
            data_mb->R_on = it->second;
          } else if (it->first == "R_off") {
            data_mb->R_off = it->second;
          } else if (it->first == "R_on2") {
            data_mb->R_on2 = it->second;
          } else if (it->first == "R_off2") {
            data_mb->R_off2 = it->second;
          } else if (it->first == "is_cutoff") {
            data_mb->is_cutoff = it->second;
          } else if (it->first == "elec_etha") {
            data_mb->elec_etha = it->second;
          } else if (it->first == "time") {
            data_mb->time = it->second;
          }
        }
        data_mb->time = 0;
      }

      void Hamiltonian_MM::set_2f_interaction(std::string t,
                                              std::string f,
                                              int id1,
                                              int id2,
                                              VECTOR& r1,
...
*/
        ...
        if (int_type == 7) {
          if (data_gay_berne == NULL) {
            data_gay_berne = new gay_berne_interaction;
          }
          // Set up parameters
          for (map<std::string, double>::iterator it = params.begin(); it != params.end(); it++) {
            if (it->first == "di") {
              data_gay_berne->di = it->second;
            } else if (it->first == "dj") {
              data_gay_berne->dj = it->second;
            } else if (it->first == "li") {
              data_gay_berne->li = it->second;
            } else if (it->first == "lj") {
              data_gay_berne->lj = it->second;
            } else if (it->first == "e0") {
              data_gay_berne->e0 = it->second;
            } else if (it->first == "rat") {
              data_gay_berne->rat = it->second;
            } else if (it->first == "dw") {
              data_gay_berne->dw = it->second;
            } else if (it->first == "mu") {
              data_gay_berne->mu = it->second;
            } else if (it->first == "nu") {
              data_gay_berne->nu = it->second;
            }
          }
          data_gay_berne->id1 = id1;
          data_gay_berne->id2 = id2;
          data_gay_berne->r1 = &r1;
          data_gay_berne->r2 = &r2;
          data_gay_berne->u1 = &u1;
          data_gay_berne->u2 = &u2;
...
*/
        ...
        if (call_type == int_type) {
          if (int_type == 0) {
            if (is_active) {
              VECTOR& r1 = *(data_bond->r1);
              VECTOR& r2 = *(data_bond->r2);
              ...
              f1 = f2 = 0.0;
              if (functional == 0) {
                energy = Bond_Harmonic(r1, r2, f1, f2, data_bond->K, data_bond->r0);
              } else if (functional == 1) {
                energy = Bond_Quartic(r1, r2, f1, f2, data_bond->K, data_bond->r0);
              } else if (functional == 2) {
                energy = Bond_Morse(r1, r2, f1, f2, data_bond->D, data_bond->r0, data_bond->alpha);
              }

              *(data_bond->f1) += f1;
              *(data_bond->f2) += f2;

              tp.tensor_product((*(data_bond->r1) - *(data_bond->r2)), f1);
              stress_at += tp;
              tp.tensor_product((*(data_bond->g1) - *(data_bond->g2)), f1);
              stress_fr += tp;
              tp.tensor_product((*(data_bond->m1) - *(data_bond->m2)), f1);
              stress_ml += tp;
            }
          }  // bond
            ...
            if (is_active) {
              VECTOR& r1 = *(data_angle->r1);
              VECTOR& r2 = *(data_angle->r2);
              VECTOR& r3 = *(data_angle->r3);
              VECTOR f1, f2, f3;
              f1 = f2 = f3 = 0.0;
              ...
              if (functional == 0) {
                energy = Angle_Harmonic(
                    r1, r2, r3, f1, f2, f3, data_angle->k_theta, data_angle->theta_0);
              } else if (functional == 1) {
                energy = Angle_Fourier(r1,
                                       r2,
                                       r3,
                                       f1,
                                       f2,
                                       ...
                                       data_angle->C1,
                                       data_angle->C2,
                                       data_angle->coordination);
              } else if (functional == 2) {
                energy = Angle_Fourier_General(r1,
                                               r2,
                                               r3,
                                               f1,
                                               f2,
                ...
                energy = Angle_Fourier_Special(
                    r1, r2, r3, f1, f2, f3, data_angle->k_theta, data_angle->coordination);
              } else if (functional == 4) {
                energy = Angle_Harmonic_Cos(r1,
                                            r2,
                                            r3,
                                            f1,
                                            f2,
                                            f3,
                                            data_angle->k_theta,
                                            data_angle->cos_theta_0,
                                            data_angle->coordination);
              } else if (functional == 5) {
                energy = Angle_Harmonic_Cos_General(
                    r1, r2, r3, f1, f2, f3, data_angle->k_theta, data_angle->cos_theta_0);
              } else if (functional == 6) {
                energy =
                    Angle_Cubic(r1, r2, r3, f1, f2, f3, data_angle->k_theta, data_angle->theta_0);
              }
              ...
              *(data_angle->f3) += f3;
              ...
              tp.tensor_product(*(data_angle->r1), f1);
              stress_at += tp;
              tp.tensor_product(*(data_angle->r2), f2);
              stress_at += tp;
              tp.tensor_product(*(data_angle->r3), f3);
              stress_at += tp;

              tp.tensor_product(*(data_angle->g1), f1);
              stress_fr += tp;
              tp.tensor_product(*(data_angle->g2), f2);
              stress_fr += tp;
              tp.tensor_product(*(data_angle->g3), f3);
              stress_fr += tp;
            ...
            if (is_active) {
              VECTOR& r1 = *(data_dihedral->r1);
              VECTOR& r2 = *(data_dihedral->r2);
              VECTOR& r3 = *(data_dihedral->r3);
              VECTOR& r4 = *(data_dihedral->r4);
              VECTOR f1, f2, f3, f4;
              f1 = f2 = f3 = f4 = 0.0;
              if (functional == 0) {
                energy = Dihedral_General(r1,
                                          r2,
                                          r3,
                                          r4,
                                          f1,
              ...
              *(data_dihedral->f4) += f4;
              ...
              tp.tensor_product(*(data_dihedral->r1), f1);
              stress_at += tp;
              tp.tensor_product(*(data_dihedral->r2), f2);
              stress_at += tp;
              tp.tensor_product(*(data_dihedral->r3), f3);
              stress_at += tp;
              tp.tensor_product(*(data_dihedral->r4), f4);
              stress_at += tp;

              tp.tensor_product(*(data_dihedral->g1), f1);
              stress_fr += tp;
              tp.tensor_product(*(data_dihedral->g2), f2);
              stress_fr += tp;
              tp.tensor_product(*(data_dihedral->g3), f3);
              stress_fr += tp;
              tp.tensor_product(*(data_dihedral->g4), f4);
              stress_fr += tp;
            ...
            if (is_active) {
              VECTOR& r1 = *(data_oop->r1);
              VECTOR& r2 = *(data_oop->r2);
              VECTOR& r3 = *(data_oop->r3);
              VECTOR& r4 = *(data_oop->r4);
              VECTOR f1, f2, f3, f4;
              f1 = f2 = f3 = f4 = 0.0;
              if (functional == 0) {
                energy = OOP_Fourier(r1,
                                     r2,
                                     r3,
                                     r4,
                                     f1,
                ...
                energy = OOP_Wilson(r1, r2, r3, r4, f1, f2, f3, f4, data_oop->K, data_oop->xi_0);
              } else if (functional == 2) {
                energy = OOP_Harmonic(r1, r2, r3, r4, f1, f2, f3, f4, data_oop->K);
              }
              ...
              *(data_oop->f4) += f4;
              ...
              tp.tensor_product(*(data_oop->r1), f1);
              stress_at += tp;
              tp.tensor_product(*(data_oop->r2), f2);
              stress_at += tp;
              tp.tensor_product(*(data_oop->r3), f3);
              stress_at += tp;
              tp.tensor_product(*(data_oop->r4), f4);
              stress_at += tp;

              tp.tensor_product(*(data_oop->g1), f1);
              stress_fr += tp;
              tp.tensor_product(*(data_oop->g2), f2);
              stress_fr += tp;
              tp.tensor_product(*(data_oop->g3), f3);
              stress_fr += tp;
              tp.tensor_product(*(data_oop->g4), f4);
              stress_fr += tp;
            ...
            if (Box == NULL) {
              if (is_active) {  // This also excludes self-pairs!
                ...
                if (SW > 0.0) {
                  if (functional == 0) {
                    en = Vdw_LJ(
                        r1, r2, f1, f2, data_vdw->sigma, data_vdw->scale * data_vdw->epsilon);
                  } else if (functional == 1) {
                    en = Vdw_Buffered14_7(
                        r1, r2, f1, f2, data_vdw->sigma, data_vdw->scale * data_vdw->epsilon);
                  } else if (functional == 2) {
                  ...
                  *(data_vdw->f2) -= f12;
                  ...
                  tp.tensor_product((*(data_vdw->r1) - *(data_vdw->r2)), f12);
                  stress_at += tp;
                  tp.tensor_product((*(data_vdw->g1) - *(data_vdw->g2)), f12);
                  stress_fr += tp;
              ...
              double fscale = 1.0;
              double tscale = 1.0;
              if (data_vdw->r1 == data_vdw->r2) {
                scale = 0.5;
              }  // Scaling of self-pairs
...
*/
              ...
              if (data_vdw->images.size() == 0) {
                ...
                if ((nxshift != data_vdw->central_translation.n1) ||
                  ...
                  double displ2 =
                      (*data_vdw->displr1_2) + (*data_vdw->displr2_2) + (*data_vdw->displT_2);
                  if (displ2 > R_skin2) {
                    is_update = 1;
                  }
                }  // else
              ...
              for (int im = 0; im < n_images; im++) {
                ...
                if ((Kx == xshift) && (Ky == yshift) && (Kz == zshift)) {
                  ...
                  if (is_active) {  // This also excludes self-pairs!
                    ...
                    if (SW > 0.0) {
                      ...
                      *(data_vdw->f2) -= f12;
                      ...
                      tp.tensor_product((*(data_vdw->r1) - *(data_vdw->r2) - T), f12);
                      stress_at += tp;
                      tp.tensor_product((*(data_vdw->g1) - *(data_vdw->g2) - T), f12);
                      stress_fr += tp;
                      //tp.tensor_product((*(data_vdw->m1) - *(data_vdw->m2)) , f12);   stress_ml += tp;
                    }  // SW>0.0
                    //--------------------------------------------------------------------------
                  ...
                  if (SW > 0.0) {
                    f1 = f2 = 0.0;
                    if (functional == 0) {
                      en = Vdw_LJ(r1, r2, f1, f2, data_vdw->sigma, scale * data_vdw->epsilon);
                    } else if (functional == 1) {
                      en = Vdw_Buffered14_7(
                          r1, r2, f1, f2, data_vdw->sigma, scale * data_vdw->epsilon);
                    } else if (functional == 2) {
                      en = Vdw_Morse(
                          r1, r2, f1, f2, scale * data_vdw->D, data_vdw->r0, data_vdw->alpha);
                    }
                    energy += SW * en;
              ...
              if (is_active) {  // This also excludes self-pairs!
                ...
                if (SW > 0.0) {
                  ...
                  *(data_elec->f2) -= f12;
                  ...
                  tp.tensor_product((*(data_elec->r1) - *(data_elec->r2)), f12);
                  stress_at += tp;
                  tp.tensor_product((*(data_elec->g1) - *(data_elec->g2)), f12);
                  stress_fr += tp;
                  //      tp.tensor_product((*(data_vdw->m1) - *(data_vdw->m2)) , f12);   stress_ml += tp;
                      ...
                      if (is_active) {  // This also excludes self-pairs!
                        ...
                        if (SW > 0.0) {
                          ...
                          *(data_elec->f2) -= f12;
                          ...
                          tp.tensor_product((*(data_elec->r1) - *(data_elec->r2) - T), f12);
                          stress_at += tp;
                          tp.tensor_product((*(data_elec->g1) - *(data_elec->g2) - T), f12);
                          stress_fr += tp;
                          //tp.tensor_product((*(data_vdw->m1) - *(data_vdw->m2)) , f12);   stress_ml += tp;
                        }  // SW>0.0
                        //--------------------------------------------------------------------------
...
*/
            ...
            if (functional == 0) {
              ...
              if (Box != NULL) {
                ...
                cout << "Use \"mb_functional\":\"vdw_LJ1\",\"mb_excl_functional\":\"vdw_LJ1\" "
                        "instead\n (only for vdW part)";
                exit(0);
              }
            ...
            if (is_active) {
              VECTOR& r1 = *(data_gay_berne->r1);
              VECTOR& r2 = *(data_gay_berne->r2);
              VECTOR& u1 = *(data_gay_berne->u1);
              VECTOR& u2 = *(data_gay_berne->u2);
              VECTOR f1, f2, t1, t2;
              energy = Gay_Berne(r1,
                                 r2,
                                 u1,
