...
namespace liblibra {
  ...
  namespace libivr {
    ...
    public:
      ...
      ivr_observable(int obs_typ_, int obs_lab_) {
        observable_type = obs_typ_;
        observable_label = obs_lab_;
      }
    };
    ...
    complex<double> MQC_prefactor_FB_G(vector<CMATRIX>& Mfwd,
                                       vector<CMATRIX>& Mbck,
                                       ivr_params& prms);

    complex<double> MQC_prefactor_FF_G(vector<CMATRIX>& Mfwd,
                                       vector<CMATRIX>& Mbck,
                                       ivr_params& prms);

    vector<complex<double> > DHK_prefactor(vector<CMATRIX>& Mfwd,
                                           vector<CMATRIX>& Mbck,
                                           ivr_params& prms);
