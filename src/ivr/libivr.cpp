...
namespace liblibra {
  ...
  namespace libivr {
    ...
    void export_ivr_objects() {
      ...
      MATRIX (*expt_ivr_Husimi_v1)(MATRIX& qIn, MATRIX& pIn, MATRIX& Width0, Random& rnd) =
          &ivr_Husimi;
      vector<MATRIX> (*expt_ivr_Husimi_v2)(
          MATRIX& qIn, MATRIX& pIn, MATRIX& Width0, Random& rnd, int sample_size) = &ivr_Husimi;
      ...
      vector<MATRIX> (*expt_ivr_LSC_v2)(
          MATRIX& qIn, MATRIX& pIn, MATRIX& Width0, Random& rnd, int sample_size) = &ivr_LSC;
      ...
      vector<MATRIX> (*expt_ivr_DHK_v2)(
          MATRIX& qIn, MATRIX& pIn, MATRIX& Width0, Random& rnd, int sample_size) = &ivr_DHK;

      def("ivr_DHK", expt_ivr_DHK_v1);
      def("ivr_DHK", expt_ivr_DHK_v2);

      MATRIX (*expt_ivr_FB_MQC_v1)(MATRIX& qIn,
                                   MATRIX& pIn,
                                   MATRIX& Width0,
                                   MATRIX& TuningQ,
                                   MATRIX& TuningP,
                                   int flag,
                                   Random& rnd) = &ivr_FB_MQC;
      vector<MATRIX> (*expt_ivr_FB_MQC_v2)(MATRIX& qIn,
                                           MATRIX& pIn,
                                           MATRIX& Width0,
                                           MATRIX& TuningQ,
                                           MATRIX& TuningP,
      ...
      complex<double> (*expt_mat_elt_FB_B_v1)(MATRIX& q, MATRIX& p, int opt, int lab) =
          &mat_elt_FB_B;
      def("mat_elt_FB_B", expt_mat_elt_FB_B_v1);

      complex<double> (*expt_mat_elt_FF_B_v1)(MATRIX& q,
                                              MATRIX& p,
                                              MATRIX& qp,
                                              MATRIX& pp,
                                              MATRIX& WidthT,
                                              MATRIX& invWidthT,
                                              int opt,
                                              int lab) = &mat_elt_FF_B;

      def("mat_elt_FF_B", expt_mat_elt_FF_B_v1);

      complex<double> (*expt_mat_elt_HUS_B_v1)(MATRIX& q, MATRIX& p, int opt, int lab) =
          &mat_elt_HUS_B;

      def("mat_elt_HUS_B", expt_mat_elt_HUS_B_v1);

      complex<double> (*expt_mat_elt_LSC_B_v1)(MATRIX& q, MATRIX& p, int opt, int lab) =
          &mat_elt_LSC_B;
      ...
      ///============ TCF calculators  ===========================
      ///  In ivr_timecorr.cpp
      void (*expt_compute_tcf_v1)(vector<complex<double> >& TCF,
                                  vector<int>& MCnum,
                                  vector<MATRIX>& q,
                                  vector<MATRIX>& p,
                                  vector<int>& status,
                                  int ivr_opt,
                                  int observable_type,
                                  int observable_label) = &compute_tcf;
      /*
...
*/
      ...
      void (*expt_normalize_tcf_v1)(vector<complex<double> >& TCF, vector<int>& MCnum) =
          &normalize_tcf;
