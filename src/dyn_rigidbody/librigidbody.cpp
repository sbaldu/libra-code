...
*/
      ...
      int (RigidBody::*init2)(int sz, boost::python::list masses, boost::python::list positions) =
          &RigidBody::init;

      int (RigidBody::*set_orientation1)(const MATRIX3x3&) = &RigidBody::set_orientation;
      int (RigidBody::*set_orientation2)(const VECTOR&, const VECTOR&, const VECTOR&) =
      ...
      int (RigidBody::*set_angular_momentum2)(const double&, const double&, const double&) =
          &RigidBody::set_angular_momentum;
      int (RigidBody::*set_angular_velocity1)(const VECTOR&) = &RigidBody::set_angular_velocity;
      int (RigidBody::*set_angular_velocity2)(const double&, const double&, const double&) =
      ...
      void (RigidBody::*Rotate6)(double phi, const VECTOR& dir, const VECTOR& pivot) =
          &RigidBody::Rotate;
      ...
      class_<RigidBody>("RigidBody", init<>())
          ...
          .def("body_frame_to_lab_frame",
               &RigidBody::body_frame_to_lab_frame,
               "convert vector from body coordinate system to the lab(external) coordinate system")
          ...
          .def("initialize_exact_rb",
               &RigidBody::initialize_exact_rb,
               "initialization of the R van Zon integrator")
          .def("propagate_exact_rb",
               &RigidBody::propagate_exact_rb,
               "exact solution for free RB problem, based on Jacoby method as discussed by R van "
               "Zon")
          ...
          .def("propagate_no_squish",
               &RigidBody::propagate_no_squish,
               "Symplectic quaternion scheme of Miller and co-workers")
          .def("initialize_terec",
               &RigidBody::initialize_terec,
               "inialization of the Terec integrator, see JCTC paper by Akimov & Kolomeisky")
          .def("propagate_terec",
               &RigidBody::propagate_terec,
               "Terec integrator with matrices, see JCTC paper by Akimov & Kolomeisky")
          .def("propagate_qterec",
               &RigidBody::propagate_qterec,
               "Terec integrator with quaternions, see JCTC paper by Akimov & Kolomeisky")
          .def("propagate_kln",
               &RigidBody::propagate_kln,
