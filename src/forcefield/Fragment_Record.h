...
namespace liblibra {
  ...
  namespace libforcefield {
    ...
    public:
      //-------------------- Type markers ----------------------
      std::string Fragment_ff_type;
      int is_Fragment_ff_type;
      int Fragment_ff_int_type;
      int is_Fragment_ff_int_type;
      //-------------------- Data -----------------------------
      // General fragment properties
      // Gay-Berne properties:
      double Fragment_di;
      int is_Fragment_di;  // fragment depth
      double Fragment_li;
      int is_Fragment_li;  // fragment length
      double Fragment_e0;
      int is_Fragment_e0;  // epsilon - interaction strength
      double Fragment_rat;
      int is_Fragment_rat;  // ratio of eps(E) to eps(S)
                            // eps(E)- well depth of end-to-end/face-to-face
                            // eps(S)- well depth of side-by-side
      double Fragment_dw;
      int is_Fragment_dw;  // correction parameter
      double Fragment_mu;
      int is_Fragment_mu;
      double Fragment_nu;
      int is_Fragment_nu;
      ...
      friend bool operator==(const Fragment_Record& e1, const Fragment_Record& e2) {
        return &e1 == &e2;
      }
      friend bool operator!=(const Fragment_Record& e1, const Fragment_Record& e2) {
        return !(e1 == e2);
    ...
    typedef std::vector<Fragment_Record>
        Fragment_RecordList;  ///< Type containing the vector of Electronic objects
