...
namespace liblibra {
  ...
  namespace libforcefield {
    ...
    void ForceField::dihedral_rule(std::string ff_type1,
                                   std::string ff_type2,
                                   std::string ff_type3,
                                   std::string ff_type4,
                                   double bond_order12,
      ...
      if (ForceField_Name == "UFF") {
        ...
        if (ff_type1.size() >= 3) {
          hyb1 = ff_type1.c_str()[2];
        } else {
          hyb1 = ' ';
        }

        if (ff_type2.size() >= 3) {
          hyb2 = ff_type2.c_str()[2];
        } else {
          hyb2 = ' ';
        }

        if (ff_type3.size() >= 3) {
          hyb3 = ff_type3.c_str()[2];
        } else {
          hyb3 = ' ';
        }

        if (ff_type4.size() >= 3) {
          hyb4 = ff_type4.c_str()[2];
        } else {
          hyb4 = ' ';
        }
        ...
        if ((hyb2 == '3') && (hyb3 == '3')) {
          ...
          if ((it1 != Vsp3.end()) && (it2 != Vsp3.end())) {
            Vphi = (sqrt((it1->second) * (it2->second)) / 9.0);
          } else {
            Vphi = (2.0 / 9.0);
          }
          n = 3;
        ...
        else if ((((hyb1 == '2') || (hyb1 == 'R')) && ((hyb2 == '2') || (hyb2 == 'R')) &&
                  (hyb3 == '3')) ||
                 (((hyb4 == '2') || (hyb4 == 'R')) && ((hyb3 == '2') || (hyb3 == 'R')) &&
                  (hyb2 == '3'))) {
          Vphi = (2.0 / 4.0);
          n = 3;
          phi0 = 180.0;
        ...
        // Case 2: (J = X_2, X_R; K = X_3 and vice versa)
          ...
          if (((elt2 == "O_" || elt2 == "S_" || elt2 == "Se" || elt2 == "Te" || elt2 == "Po") &&
            ...
            if ((it1 != Usp2.end()) && (it2 != Usp2.end())) {
              Vphi = 0.25 * 5.0 * sqrt((it1->second) * (it2->second)) *
                     (1.0 + 4.18 * log(bond_order23));
            } else {
              is_Vphi = 0;
            }
            phi0 = 90.0;
        ...
        // Case 3: (J,K=X_2)
          ...
          if ((it1 != Usp2.end()) && (it2 != Usp2.end())) {
            Vphi =
                0.25 * 5.0 * sqrt((it1->second) * (it2->second)) * (1.0 + 4.18 * log(bond_order23));
          } else {
            Vphi = (45.0 / 4.0);
          }
          n = 2;
    ...
    int ForceField::get_dihedral_parameters(string ff_type1,
