...
namespace liblibra {
  ...
  namespace libforcefield {
    ...
    int (ForceField::*Add_Dihedral_Record2)(Dihedral_Record,
                                            int) = &ForceField::Add_Dihedral_Record;
    ...
    void export_forcefield_objects() {
      ...
      class_<Atom_RecordList>("Atom_RecordList").def(vector_indexing_suite<Atom_RecordList>());
      ...
      class_<Bond_RecordList>("Bond_RecordList").def(vector_indexing_suite<Bond_RecordList>());
      ...
      class_<Angle_RecordList>("Angle_RecordList").def(vector_indexing_suite<Angle_RecordList>());
