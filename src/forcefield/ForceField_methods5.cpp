...
namespace liblibra {
  ...
  namespace libforcefield {
    ...
    void ForceField::oop_rule(std::string ff_type1,
                              std::string ff_type2,
                              std::string ff_type3,
                              std::string ff_type4,
                              double& K,
    ...
    int ForceField::get_oop_parameters(string ff_type1,
...
******************************************************************/
      ...
      is_Vphi = is_Vphi1 = is_Vphi2 = is_Vphi3 = is_phi0 = is_n = is_opt = is_K = is_C0 = is_C1 =
          is_C2 = 0;
      int status = 0;
      ...
      if (ff_dihedral_indx > -1) {  // if the record has been found
        ...
        if (Dihedral_Records[ff_dihedral_indx].is_Dihedral_phase) {
          phi0 = Dihedral_Records[ff_dihedral_indx].Dihedral_phase;
          is_phi0 = 1;
        }
