...
namespace liblibra {
  ...
  namespace libforcefield {
    ...
    public:
      ...
      int is_Atom_ff_type;
      std::string Atom_ff_type_H;
      int is_Atom_ff_type_H;
      int Atom_ff_int_type;
      int is_Atom_ff_int_type;
      std::string Atom_element;
      int is_Atom_element;
      int Atom_atomic_number;
      int is_Atom_atomic_number;
      //-------------------- Data -----------------------------
      // General atom properties
      double Atom_electronegativity;
      int is_Atom_electronegativity;
      double Atom_partial_charge;
      int is_Atom_partial_charge;
      // Atom type equivalences (used in many force fields)
      int Atom_ff_eq_int_type2;
      int is_Atom_ff_eq_int_type2;
      int Atom_ff_eq_int_type3;
      int is_Atom_ff_eq_int_type3;
      int Atom_ff_eq_int_type4;
      int is_Atom_ff_eq_int_type4;
      int Atom_ff_eq_int_type5;
      int is_Atom_ff_eq_int_type5;

      // UFF and DREIDING force field parameters
      double Atom_radius;
      int is_Atom_radius;
      double Atom_Z_star;
      int is_Atom_Z_star;  // Effective charge of atom(UFF)
      double Atom_theta;
      int is_Atom_theta;  // Valence angle (in degrees)
      double Atom_sigma;
      int is_Atom_sigma;  // vdw radius of atom
      double Atom_epsilon;
      int is_Atom_epsilon;  // vdw well depth for atom (D in terms of UFF)
      double Atom_GMP;
      int is_Atom_GMP;  // Generalized electronegativity
    ...
    typedef std::vector<Atom_Record>
        Atom_RecordList;  ///< Type containing the vector of Electronic objects
