...
*/
      ...
      void (*expt_model_SAC_v1)(CMATRIX& Hdia,
                                CMATRIX& Sdia,
      ...
      void (*expt_model_DAC_v1)(CMATRIX& Hdia,
                                CMATRIX& Sdia,
                                vector<CMATRIX>& d1ham_dia,
                                vector<CMATRIX>& dc1_dia,
                                vector<double>& q,
      ...
      void (*expt_model_ECWR_v1)(CMATRIX& Hdia,
                                 CMATRIX& Sdia,
                                 vector<CMATRIX>& d1ham_dia,
                                 vector<CMATRIX>& dc1_dia,
                                 vector<double>& q,
      ...
      void (*expt_model_1S_1D_poly2_v1)(CMATRIX& Hdia,
                                        CMATRIX& Sdia,
                                        vector<CMATRIX>& d1ham_dia,
                                        vector<CMATRIX>& dc1_dia,
                                        vector<double>& q,
                                        vector<double>& params) = &model_1S_1D_poly2;

      void (*expt_model_1S_1D_poly4_v1)(CMATRIX& Hdia,
                                        CMATRIX& Sdia,
                                        vector<CMATRIX>& d1ham_dia,
                                        vector<CMATRIX>& dc1_dia,
                                        vector<double>& q,
                                        vector<double>& params) = &model_1S_1D_poly4;
      ...
      void (*expt_model_2S_1D_sin_v1)(CMATRIX& Hdia,
                                      CMATRIX& Sdia,
                                      vector<CMATRIX>& d1ham_dia,
                                      vector<CMATRIX>& dc1_dia,
                                      vector<double>& q,
      ...
      void (*expt_model_2S_2D_sin_v1)(CMATRIX& Hdia,
                                      CMATRIX& Sdia,
                                      vector<CMATRIX>& d1ham_dia,
                                      vector<CMATRIX>& dc1_dia,
                                      vector<double>& q,
      ...
      void (*expt_model_2S_1D_tanh_v1)(CMATRIX& Hdia,
                                       CMATRIX& Sdia,
                                       vector<CMATRIX>& d1ham_dia,
                                       vector<CMATRIX>& dc1_dia,
                                       vector<double>& q,
                                       vector<double>& params) = &model_2S_1D_tanh;
