  ...
  namespace libscripts {
    namespace libstate {
      ...
      void export_state_objects() {
        ...
        void (State::*expt_init_md_v1)(
            Nuclear& mol, Electronic& el, Hamiltonian& ham, Random& rnd) = &State::init_md;
        void (State::*expt_init_md_v2)(Electronic& el, Hamiltonian& ham, Random& rnd) =
            &State::init_md;

        void (State::*expt_run_md_v1)(Nuclear& mol, Electronic& el, Hamiltonian& ham) =
            &State::run_md;
