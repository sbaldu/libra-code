...
*/
      ...
      int n1, n2,
          n3;  ///< integers describing the position of the given cell in the 3D grid of replicas of the
               ///< original unit cell
    };
...
*/
      ...
      int at_indx1,
          at_indx2;  ///< indices of the interacting atoms (this defines the excluded(or not) pair)
...
*/
      ...
      // Data variables
      VECTOR t1;
      int is_t1;  ///< basis vector 1 (a direction) and the status flag
      VECTOR t2;
      int is_t2;  ///< basis vector 2 (a direction) and the status flag
      VECTOR t3;
      int is_t3;  ///< basis vector 3 (a direction) and the status flag
      double Roff;
      int is_Roff;  ///< neighbour distance cut off and the status flag
