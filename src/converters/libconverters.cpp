  ...
  namespace libconverters {
    ...
    void export_converters_objects() {
      ...
      class_<StringDoubleMap>("StringDoubleMap")
          ...
          .def("__getitem__",
               &map_item<StringDoubleMap>::get,
               return_value_policy<copy_non_const_reference>())
          .def("__setitem__",
               &map_item<StringDoubleMap>::set,
      ...
      class_<StringIntMap>("StringIntMap")
          ...
          .def("__getitem__",
               &map_item<StringIntMap>::get,
               return_value_policy<copy_non_const_reference>())
          .def("__setitem__",
               &map_item<StringIntMap>::set,
               with_custodian_and_ward<1, 2>())  // to let container keep value
      ...
      class_<StringVDoubleMap>("StringVDoubleMap")
          ...
          .def("__getitem__",
               &map_item<StringVDoubleMap>::get,
               return_value_policy<copy_non_const_reference>())
          .def("__setitem__",
               &map_item<StringVDoubleMap>::set,
               with_custodian_and_ward<1, 2>())  // to let container keep value
