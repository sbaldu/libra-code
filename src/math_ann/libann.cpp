  ...
  namespace libann {
    ...
    void export_NeuralNetwork_objects() {
      void (NeuralNetwork::*expt_init_weights_biases_uniform_v1)(
          ...
          &NeuralNetwork::init_weights_biases_uniform;
      void (NeuralNetwork::*expt_init_weights_biases_normal_v1)(
          ...
          &NeuralNetwork::init_weights_biases_normal;

      vector<MATRIX> (NeuralNetwork::*expt_propagate_v1)(MATRIX& input) = &NeuralNetwork::propagate;
      vector<MATRIX> (NeuralNetwork::*expt_derivatives_v1)(MATRIX& input) =
          &NeuralNetwork::derivatives;
      double (NeuralNetwork::*expt_back_propagate_v1)(vector<MATRIX>& Y, MATRIX& target) =
