...
namespace liblibra {
  ...
  namespace libmodel_parameters {
    ...
    void export_Model_Parameters_objects() {
      ...
      class_<HF_integralsList>("HF_integralsList").def(vector_indexing_suite<HF_integralsList>());
      class_<HF_integralsMap>("HF_integralsMap").def(vector_indexing_suite<HF_integralsMap>());
      ...
      class_<EHT_KList>("EHT_KList").def(vector_indexing_suite<EHT_KList>());
      class_<EHT_KMap>("EHT_KMap").def(vector_indexing_suite<EHT_KMap>());
      ...
      class_<mEHT_KList>("mEHT_KList").def(vector_indexing_suite<mEHT_KList>());
      class_<mEHT_KMap>("mEHT_KMap").def(vector_indexing_suite<mEHT_KMap>());
      ...
      class_<pElementList>("pElementList").def(vector_indexing_suite<pElementList>());
      class_<pElementMap>("pElementMap").def(vector_indexing_suite<pElementMap>());
      ...
      class_<OrbParamsList>("OrbParamsList").def(vector_indexing_suite<OrbParamsList>());
      class_<OrbParamsMap>("OrbParamsMap").def(vector_indexing_suite<OrbParamsMap>());
      ...
      void (*expt_set_parameters_hf_v1)(Control_Parameters&, Model_Parameters&, vector<AO>&) =
          &set_parameters_hf;

      void (*expt_set_parameters_indo_v1)(Control_Parameters&, Model_Parameters&) =
          &set_parameters_indo;

      void (*expt_set_parameters_eht_v1)(Control_Parameters& prms, Model_Parameters& modprms) =
          &set_parameters_eht;
      ...
      void (*expt_set_parameters_eht_mapping1_v1)(
          Model_Parameters& modprms, int nat, vector<std::string>& mol_at_types) =
          &set_parameters_eht_mapping1;
