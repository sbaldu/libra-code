...
namespace liblibra {
  ...
  namespace libmeigen {
    ...
    void export_mEigen_objects() {
      ...
      void (*expt_solve_eigen_v1)(CMATRIX& H, CMATRIX& S, CMATRIX& E, CMATRIX& C, int symm) =
          &solve_eigen;
      void (*expt_solve_eigen_v2)(MATRIX& H, MATRIX& S, CMATRIX& E, CMATRIX& C, int symm) =
          &solve_eigen;
      void (*expt_solve_eigen_v3)(MATRIX& H, MATRIX& S, MATRIX& E, MATRIX& C, int symm) =
          &solve_eigen;
      ...
      void (*expt_solve_eigen_nosort_v1)(CMATRIX& H, CMATRIX& E, CMATRIX& C, int symm) =
          &solve_eigen_nosort;
      void (*expt_solve_eigen_nosort_v2)(MATRIX& H, CMATRIX& E, CMATRIX& C, int symm) =
          &solve_eigen_nosort;
      void (*expt_solve_eigen_nosort_v3)(MATRIX& H, MATRIX& E, MATRIX& C, int symm) =
          &solve_eigen_nosort;
      ...
      void (*expt_sqrt_matrix_v1)(
          CMATRIX& S, CMATRIX& S_half, CMATRIX& S_i_half, double thresh, int do_phase_correction) =
          &sqrt_matrix;
      void (*expt_sqrt_matrix_v2)(CMATRIX& S, CMATRIX& S_half, CMATRIX& S_i_half, double thresh) =
          &sqrt_matrix;
      ...
      void (*expt_inv_matrix_v1)(
          CMATRIX& S, CMATRIX& S_inv, double thresh, int do_phase_correction) = &inv_matrix;
      ...
      void (*expt_inv_matrix_v4)(MATRIX& S, MATRIX& S_inv, double thresh, int do_phase_correction) =
          &inv_matrix;
      ...
      void (*expt_exp_matrix_v1)(
          CMATRIX& res, CMATRIX& S, complex<double> dt, int do_phase_correction) = &exp_matrix;
      ...
      void (*expt_FullPivLU_rank_invertible_v1)(MATRIX& A, int& rank, int& is_inver) =
          &FullPivLU_rank_invertible;
      void (*expt_FullPivLU_rank_invertible_v2)(CMATRIX& A, int& rank, int& is_inver) =
          &FullPivLU_rank_invertible;
      boost::python::list (*expt_FullPivLU_rank_invertible_v3)(MATRIX& A) =
          &FullPivLU_rank_invertible;
      boost::python::list (*expt_FullPivLU_rank_invertible_v4)(CMATRIX& A) =
          &FullPivLU_rank_invertible;
      ...
      void (*expt_FullPivLU_decomposition_v1)(
          MATRIX& A, MATRIX& P, MATRIX& L, MATRIX& U, MATRIX& Q) = &FullPivLU_decomposition;
      void (*expt_FullPivLU_decomposition_v2)(
          CMATRIX& A, CMATRIX& P, CMATRIX& L, CMATRIX& U, CMATRIX& Q) = &FullPivLU_decomposition;
      ...
      void (*expt_JacobiSVD_decomposition_v1)(CMATRIX& A, CMATRIX& U, CMATRIX& S, CMATRIX& V) =
          &JacobiSVD_decomposition;
      void (*expt_BDCSVD_decomposition_v1)(CMATRIX& A, CMATRIX& U, CMATRIX& S, CMATRIX& V) =
          &BDCSVD_decomposition;
      ...
      void (*expt_least_squares_solve_v1)(MATRIX& A, MATRIX& X, MATRIX& B, int option) =
          least_squares_solve;
      def("least_squares_solve", expt_least_squares_solve_v1);

      bool (*expt_linsys_solver_v1)(
          const MATRIX& A, MATRIX& X, const MATRIX& B, const double NormThreshold) = &linsys_solver;
      def("linsys_solver", expt_linsys_solver_v1);

      void (*expt_solve_linsys_v1)(MATRIX& C, MATRIX& D, MATRIX& X, double eps, int maxiter) =
          &solve_linsys;
