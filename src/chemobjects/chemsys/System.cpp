  ...
  namespace libchemobjects {
    ...
    namespace libchemsys {
      ...
      void System::init_variables() {
        ...
        GroupConnMatrix = NULL;
        is_GroupConnMatrix = 0;
        is_AtomGraph = 0;
...
*/
      ...
      void System::copy_content(const System& sys) {
        if (sys.is_max_atom_id) {
          max_atom_id = sys.max_atom_id;
          is_max_atom_id = 1;
        }
        if (sys.is_max_fragment_id) {
          max_fragment_id = sys.max_fragment_id;
          is_max_fragment_id = 1;
        }
        if (sys.is_max_molecule_id) {
          max_molecule_id = sys.max_molecule_id;
          is_max_molecule_id = 1;
        }
        ...
        if (sys.is_Box_origin) {
          Box_origin = sys.Box_origin;
          is_Box_origin = 1;
        }
        if (sys.is_dT_2) {
          dT_2 = sys.dT_2;
...
*/
        ...
        if (is_Boxold) {
          std::cout << " Boxold = " << Boxold << std::endl;
        }
        if (is_name) {
