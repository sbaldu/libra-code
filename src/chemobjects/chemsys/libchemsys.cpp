...
*/
        ...
        void (System::*print_ent4)(std::string, boost::python::list, int, std::string) =
            &System::print_ent;
        ...
        std::string (System::*expt_get_xyz_v1)(int fold, std::string pbc_type, int frame) =
            &System::get_xyz;

        int (System::*expt_Find_Angle_v1)(int, int) = &System::Find_Angle;
        int (System::*expt_Find_Angle_v2)(int, int, int) = &System::Find_Angle;

        void (System::*expt_init_fragment_velocities_v1)(double Temp, Random& rnd) =
            &System::init_fragment_velocities;
        void (System::*expt_init_fragment_velocities_v2)(
            double Temp, VECTOR TOT_P, VECTOR TOT_L, Random& rnd) =
            &System::init_fragment_velocities;

        void (System::*expt_init_atom_velocities_v1)(double Temp, Random& rnd) =
            &System::init_atom_velocities;
        void (System::*expt_init_atom_velocities_v2)(double Temp, VECTOR TOT_P, Random& rnd) =
            &System::init_atom_velocities;

        void (System::*expt_ROTATE_FRAGMENT_v1)(
            double phi, const VECTOR& dir, int fr_id, const VECTOR& pivot) =
            &System::ROTATE_FRAGMENT;
        void (System::*expt_ROTATE_FRAGMENT_v2)(
            double phi, const VECTOR& dir, int fr_id, int center_indx) = &System::ROTATE_FRAGMENT;
        void (System::*expt_ROTATE_FRAGMENT_v3)(double phi, const VECTOR& dir, int fr_id) =
            &System::ROTATE_FRAGMENT;
        void (System::*expt_ROTATE_FRAGMENT_v4)(
            const MATRIX3x3& rot, int fr_id, const VECTOR& pivot) = &System::ROTATE_FRAGMENT;
        void (System::*expt_ROTATE_FRAGMENT_v5)(const MATRIX3x3& rot, int fr_id, int center_indx) =
            &System::ROTATE_FRAGMENT;
        void (System::*expt_ROTATE_FRAGMENT_v6)(const MATRIX3x3& rot, int fr_id) =
            &System::ROTATE_FRAGMENT;
