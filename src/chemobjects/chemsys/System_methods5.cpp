...
*/
        ...
        if (q.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::extract_atomic_q: dimensions of System and vector<double> "
...
*/
        ...
        if (q.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::set_atomic_q: dimensions of System and vector<double> objects "
                  "are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (p.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::extract_atomic_p: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (p.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::set_atomic_p: dimensions of System and vector<double> objects "
                  "are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (v.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::extract_atomic_v: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (v.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::set_atomic_v: dimensions of System and vector<double> objects "
                  "are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (f.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::extract_atomic_f: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (f.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::set_atomic_f: dimensions of System and vector<double> objects "
                  "are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (mass.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::extract_atomic_mass: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
...
*/
        ...
        if (mass.size() != 3.0 * Number_of_atoms) {
          cout << "Error: in System::set_atomic_mass: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }

        for (int i = 0; i < Number_of_atoms; i++) {
          Atoms[i].Atom_RB.set_mass(
              mass[3 * i + 0]);  // assume mass[3*i+0] = mass[3*i+1] = mass[3*i+2]
      ...
      void System::extract_fragment_q(vector<double>& q) {
        ...
        if (q.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::extract_fragment_q: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
      ...
      void System::set_fragment_q(vector<double>& q) {
        ...
        if (q.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::set_fragment_q: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
      ...
      void System::extract_fragment_p(vector<double>& p) {
        ...
        if (p.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::extract_fragment_p: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
      ...
      void System::set_fragment_p(vector<double>& p) {
        ...
        if (p.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::set_fragment_p: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
      ...
      void System::extract_fragment_v(vector<double>& v) {
        ...
        if (v.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::extract_fragment_v: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
      ...
      void System::set_fragment_v(vector<double>& v) {
        ...
        if (v.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::set_fragments_v: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
      ...
      void System::extract_fragment_f(vector<double>& f) {
        ...
        if (f.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::extract_fragment_f: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
      ...
      void System::set_fragment_f(vector<double>& f) {
        ...
        if (f.size() != 3.0 * Number_of_fragments) {
          cout << "Error: in System::set_fragment_f: dimensions of System and vector<double> "
                  "objects are not compatible\n";
          exit(0);
        }
