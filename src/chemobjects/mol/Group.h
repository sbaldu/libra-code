  ...
  namespace libchemobjects {
    namespace libmol {
      ...
      public:
        ...
        std::string Group_ff_type;
        int is_Group_ff_type;
        ...
        // Bonds
        double Group_bond_order;
        int is_Group_bond_order;
        double Group_bond_alpha;
        int is_Group_bond_alpha;
        ...
        bool operator!=(const Group& a) const { return globGroup_Index != a.globGroup_Index; }
        friend ostream& operator<<(ostream& strm, Group& ob) {
          ob.show_info();
          return strm;
        }
