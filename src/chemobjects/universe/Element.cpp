  ...
  namespace libchemobjects {
    ...
    namespace libuniverse {
      ...
      void Element::copy_content(const Element& at) {
        if (at.is_Elt_name) {
          Elt_name = at.Elt_name;
          is_Elt_name = 1;
        }
        if (at.is_Elt_mass) {
          Elt_mass = at.Elt_mass;
          is_Elt_mass = 1;
        }
        if (at.is_Elt_number) {
          Elt_number = at.Elt_number;
          is_Elt_number = 1;
        }
        if (at.is_Elt_nucleus_charge) {
          Elt_nucleus_charge = at.Elt_nucleus_charge;
          is_Elt_nucleus_charge = 1;
        }
        if (at.is_Elt_period) {
          Elt_period = at.Elt_period;
          is_Elt_period = 1;
        }
        if (at.is_Elt_group) {
          Elt_group = at.Elt_group;
          is_Elt_group = 1;
        }
        if (at.is_Elt_block) {
          Elt_block = at.Elt_block;
          is_Elt_block = 1;
        }
        if (at.is_Elt_red) {
          Elt_red = at.Elt_red;
        ...
        if (at.is_Elt_green) {
          Elt_green = at.Elt_green;
          is_Elt_green = 1;
        }
        if (at.is_Elt_blue) {
          Elt_blue = at.Elt_blue;
          is_Elt_blue = 1;
        }
        if (at.is_Elt_bond_length) {
          Elt_bond_length = at.Elt_bond_length;
          is_Elt_bond_length = 1;
        }
        if (at.is_Elt_radius) {
          Elt_radius = at.Elt_radius;
          is_Elt_radius = 1;
        }
      }
...
*/
        ...
        if (is_Elt_name) {
          std::cout << "Elt_name = " << Elt_name << std::endl;
        }
        if (is_Elt_mass) {
          std::cout << "Elt_mass = " << Elt_mass << std::endl;
        }
        if (is_Elt_number) {
          std::cout << "Elt_number = " << Elt_number << std::endl;
        }
        if (is_Elt_nucleus_charge) {
          std::cout << "Elt_nucleus_charge = " << Elt_nucleus_charge << std::endl;
        }
        if (is_Elt_period) {
          std::cout << "Elt_period = " << Elt_period << std::endl;
        }
        if (is_Elt_group) {
          std::cout << "Elt_group = " << Elt_group << std::endl;
        }
        if (is_Elt_block) {
          std::cout << "Elt_block = " << Elt_block << std::endl;
        }
        if (is_Elt_red) {
          std::cout << "Elt_red = " << Elt_red << std::endl;
        }
        if (is_Elt_green) {
          std::cout << "Elt_green = " << Elt_green << std::endl;
        }
        if (is_Elt_blue) {
          std::cout << "Elt_blue = " << Elt_blue << std::endl;
        }
        if (is_Elt_bond_length) {
          std::cout << "Elt_bond_length = " << Elt_bond_length << std::endl;
        }
        if (is_Elt_radius) {
          std::cout << "Elt_radius = " << Elt_radius << std::endl;
        }
        std::cout << std::endl;
      }
...
*/
        ...
        if (is_Elt_name) {
          libio::save(pt, path + ".Elt_name", Elt_name);
        }
        if (is_Elt_id) {
          libio::save(pt, path + ".Elt_id", Elt_id);
        }
        if (is_Elt_mass) {
          libio::save(pt, path + ".Elt_mass", Elt_mass);
        }
        if (is_Elt_number) {
          libio::save(pt, path + ".Elt_number", Elt_number);
        }
        if (is_Elt_nucleus_charge) {
          libio::save(pt, path + ".Elt_nucleus_charge", Elt_nucleus_charge);
        }
        if (is_Elt_period) {
          libio::save(pt, path + ".Elt_period", Elt_period);
        }
        if (is_Elt_group) {
          libio::save(pt, path + ".Elt_group", Elt_group);
        }
        if (is_Elt_block) {
          libio::save(pt, path + ".Elt_block", Elt_block);
        }
        if (is_Elt_red) {
          libio::save(pt, path + ".Elt_red", Elt_red);
        }
        if (is_Elt_green) {
          libio::save(pt, path + ".Elt_green", Elt_green);
        }
        if (is_Elt_blue) {
          libio::save(pt, path + ".Elt_blue", Elt_blue);
        }
        if (is_Elt_bond_length) {
          libio::save(pt, path + ".Elt_bond_length", Elt_bond_length);
        }
        if (is_Elt_radius) {
          libio::save(pt, path + ".Elt_radius", Elt_radius);
        }
      }
...
*/
        ...
        libio::load(pt, path + ".Elt_name", Elt_name, is_Elt_name);
        if (is_Elt_name == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_id", Elt_id, is_Elt_id);
        if (is_Elt_id == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_mass", Elt_mass, is_Elt_mass);
        if (is_Elt_mass == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_number", Elt_number, is_Elt_number);
        if (is_Elt_number == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_nucleus_charge", Elt_nucleus_charge, is_Elt_nucleus_charge);
        if (is_Elt_nucleus_charge == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_period", Elt_period, is_Elt_period);
        if (is_Elt_period == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_group", Elt_group, is_Elt_group);
        if (is_Elt_group == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_block", Elt_block, is_Elt_block);
        if (is_Elt_block == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_red", Elt_red, is_Elt_red);
        if (is_Elt_red == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_green", Elt_green, is_Elt_green);
        if (is_Elt_green == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_blue", Elt_blue, is_Elt_blue);
        if (is_Elt_blue == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_bond_length", Elt_bond_length, is_Elt_bond_length);
        if (is_Elt_bond_length == 1) {
          status = 1;
        }
        libio::load(pt, path + ".Elt_radius", Elt_radius, is_Elt_radius);
        if (is_Elt_radius == 1) {
          status = 1;
        }
      }
