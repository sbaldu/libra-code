...
*/
      ...
      Context (Context::*expt_get_child_v1)(
          std::string _path, std::string varname, Context default_val) = &Context::get_child;
      Context (Context::*expt_get_child_v2)(std::string varname, Context default_val) =
          &Context::get_child;

      vector<Context> (Context::*expt_get_children_v1)(std::string _path, std::string varname) =
          &Context::get_children;
      vector<Context> (Context::*expt_get_children_v2)(std::string varname) =
          &Context::get_children;
      vector<Context> (Context::*expt_get_children_all_v1)(std::string _path) =
          &Context::get_children_all;
      ...
      vector<int> (Context::*expt_get_v2)(std::string varname, vector<int> default_val) =
          &Context::get1;

      std::string (Context::*expt_get_v3)(std::string varname, std::string default_val) =
          &Context::get1;
      vector<std::string> (Context::*expt_get_v4)(std::string varname,
                                                  vector<std::string> default_val) = &Context::get1;

      double (Context::*expt_get_v5)(std::string varname, double default_val) = &Context::get1;
      vector<double> (Context::*expt_get_v6)(std::string varname, vector<double> default_val) =
          &Context::get1;

      VECTOR (Context::*expt_get_v7)(std::string varname, VECTOR& default_val) = &Context::get2;
      vector<VECTOR> (Context::*expt_get_v8)(std::string varname, vector<VECTOR>& default_val) =
          &Context::get2;

      QUATERNION (Context::*expt_get_v9)(std::string varname, QUATERNION& default_val) =
          &Context::get2;
      vector<QUATERNION> (Context::*expt_get_v10)(std::string varname,
                                                  vector<QUATERNION>& default_val) = &Context::get2;

      MATRIX3x3 (Context::*expt_get_v11)(std::string varname, MATRIX3x3& default_val) =
          &Context::get2;
      vector<MATRIX3x3> (Context::*expt_get_v12)(std::string varname,
                                                 vector<MATRIX3x3>& default_val) = &Context::get2;

      MATRIX (Context::*expt_get_v13)(std::string varname, MATRIX& default_val) = &Context::get2;
      vector<MATRIX> (Context::*expt_get_v14)(std::string varname, vector<MATRIX>& default_val) =
          &Context::get2;
...
*/
      ...
      class_<ContextList>("ContextList").def(vector_indexing_suite<ContextList>());

      class_<ContextMap>("ContextMap").def(vector_indexing_suite<ContextMap>());
    }
