...
*/
      ...
      class_<Control_Parameters>("Control_Parameters", init<>())
          ...
          .def_readwrite("nac_md_trajectory_filename",
                         &Control_Parameters::nac_md_trajectory_filename)
      ...
      void (*expt_get_parameters_from_file_v1)(std::string, Control_Parameters&) =
