...
*/
      ...
      void (*expt_charge_density_v1)(
          Electronic_Structure& el, System& syst, vector<AO>& basis_ao, Control_Parameters& prms) =
          &charge_density;

      void (*expt_charge_density_v2)(MATRIX& C,
                                     vector<listHamiltonian_QM>& ham,
                                     System& syst,
                                     vector<vector<int> >& active_orb,
                                     Control_Parameters& prms) = &charge_density;

      void (*expt_charge_density_v3)(MATRIX& C,
      ...
      void (*expt_compute_dos_v1)(Electronic_Structure& el,
                                  vector<AO>& basis_ao,
                                  Control_Parameters& prms,
                                  vector<int>& fragment,
                                  vector<vector<int> >& atom_to_ao_map) = &compute_dos;

      void (*expt_compute_dos_v2)(Electronic_Structure& el,
                                  vector<AO>& basis_ao,
                                  Control_Parameters& prms,
                                  boost::python::list fragment,
                                  vector<vector<int> >& atom_to_ao_map) = &compute_dos;

      void (*expt_compute_dos_v3)(Electronic_Structure& el,
                                  System& syst,
                                  vector<AO>& basis_ao,
                                  Control_Parameters& prms,
                                  vector<vector<int> >& atom_to_ao_map) = &compute_dos;
