...
*/
      ...
      //==================  Overlaps ===========================
      double (*expt_gaussian_overlap_G_v1)(PrimitiveG& GA, PrimitiveG& GB) = &gaussian_overlap;
      double (*expt_gaussian_overlap_G_v2)(PrimitiveG& GA, PrimitiveG& GB, int is_normalize) =
          &gaussian_overlap;
      boost::python::list (*expt_gaussian_overlap_G_v3)(
          PrimitiveG& GA, PrimitiveG& GB, int is_normalize, int is_derivs) = &gaussian_overlap;

      double (*expt_gaussian_overlap_AO_v1)(AO& AOa, AO& AOb) = &gaussian_overlap;
      double (*expt_gaussian_overlap_AO_v2)(AO& AOa, AO& AOb, int is_normalize) = &gaussian_overlap;
      boost::python::list (*expt_gaussian_overlap_AO_v3)(
          AO& AOa, AO& AOb, int is_normalize, int is_derivs) = &gaussian_overlap;

      //==================  Moments ===========================
      double (*expt_gaussian_moment_G_v1)(PrimitiveG& GA, PrimitiveG& G, PrimitiveG& GB) =
          &gaussian_moment;
      ...
      double (*expt_gaussian_moment_AO_v1)(AO& AOa, PrimitiveG& G, AO& AOb) = &gaussian_moment;
      double (*expt_gaussian_moment_AO_v2)(AO& AOa, PrimitiveG& G, AO& AOb, int is_normalize) =
          &gaussian_moment;
      ...
      double (*expt_pseudopot02_G_v1)(
          double C0, double C2, double alp, const VECTOR& R, PrimitiveG& GA, PrimitiveG& GB) =
          &pseudopot02;
      double (*expt_pseudopot02_G_v2)(double C0,
                                      double C2,
                                      double alp,
                                      const VECTOR& R,
                                      PrimitiveG& GA,
                                      PrimitiveG& GB,
                                      int is_normalize) = &pseudopot02;
      boost::python::list (*expt_pseudopot02_G_v3)(double C0,
                                                   double C2,
                                                   double alp,
                                                   const VECTOR& R,
                                                   PrimitiveG& GA,
      ...
      double (*expt_pseudopot02_AO_v2)(
          double C0, double C2, double alp, const VECTOR& R, AO& AOa, AO& AOb, int is_normalize) =
          &pseudopot02;
      boost::python::list (*expt_pseudopot02_AO_v3)(double C0,
                                                    double C2,
                                                    double alp,
                                                    const VECTOR& R,
                                                    AO& AOa,
      ...
      //==================  Kinetic integrals ===========================
      double (*expt_kinetic_integral_G_v1)(PrimitiveG& GA, PrimitiveG& GB) = &kinetic_integral;
      double (*expt_kinetic_integral_G_v2)(PrimitiveG& GA, PrimitiveG& GB, int is_normalize) =
          &kinetic_integral;
      boost::python::list (*expt_kinetic_integral_G_v3)(
          PrimitiveG& GA, PrimitiveG& GB, int is_normalize, int is_derivs) = &kinetic_integral;

      double (*expt_kinetic_integral_AO_v1)(AO& AOa, AO& AOb) = &kinetic_integral;
      double (*expt_kinetic_integral_AO_v2)(AO& AOa, AO& AOb, int is_normalize) = &kinetic_integral;
      boost::python::list (*expt_kinetic_integral_AO_v3)(
          AO& AOa, AO& AOb, int is_normalize, int is_derivs) = &kinetic_integral;

      //==================  NAI ===========================
      double (*expt_nuclear_attraction_integral_G_v1)(PrimitiveG& GA, PrimitiveG& GB, VECTOR& Rc) =
          &nuclear_attraction_integral;
      double (*expt_nuclear_attraction_integral_G_v2)(
          PrimitiveG& GA, PrimitiveG& GB, VECTOR& Rc, int is_normalize) =
          &nuclear_attraction_integral;
      boost::python::list (*expt_nuclear_attraction_integral_G_v3)(
          PrimitiveG& GA, PrimitiveG& GB, VECTOR& Rc, int is_normalize, int is_derivs) =
          &nuclear_attraction_integral;

      double (*expt_nuclear_attraction_integral_AO_v1)(AO& AOa, AO& AOb, VECTOR& Rc) =
          &nuclear_attraction_integral;
      ...
      double (*expt_electron_repulsion_integral_G_v2)(
          PrimitiveG& GA, PrimitiveG& GB, PrimitiveG& GC, PrimitiveG& GD, int is_normalize) =
          &electron_repulsion_integral;
      boost::python::list (*expt_electron_repulsion_integral_G_v3)(PrimitiveG& GA,
                                                                   PrimitiveG& GB,
                                                                   PrimitiveG& GC,
                                                                   PrimitiveG& GD,
                                                                   int is_normalize,
      ...
      double (*expt_electron_repulsion_integral_AO_v1)(AO& AOa, AO& AOb, AO& AOc, AO& AOd) =
          &electron_repulsion_integral;
      ...
      boost::python::list (*expt_electron_repulsion_integral_AO_v3)(
          AO& AOa, AO& AOb, AO& AOc, AO& AOd, int is_normalize, int is_derivs) =
          &electron_repulsion_integral;
      ...
      class_<PrimitiveGList>("PrimitiveGList").def(vector_indexing_suite<PrimitiveGList>());
      ...
      class_<AOList>("AOList").def(vector_indexing_suite<AOList>());
      ...
      class_<PWList>("PWList").def(vector_indexing_suite<PWList>());

      complex<double> (*expt_I_1D_v1)(double kx, double kxp, double gx, double gxp) = &I_1D;

      complex<double> (*expt_I_3D_v1)(VECTOR& k, VECTOR& kp, VECTOR& g, VECTOR& gp) = &I_3D;
      ...
      (VECTOR & k1,
       ...
       CMATRIX & coeff2,
       vector<VECTOR> & grid1,
       vector<VECTOR> & grid2) = &pw_overlap;
      ...
      vector<CMATRIX> (*expt_compute_Hprime_v1)(CMATRIX& wfc, MATRIX& grid, MATRIX& reci) =
          &compute_Hprime;
      ...
      void (SD::*expt_set_v2)(CMATRIX& _mo_pool_alp,
                              CMATRIX& _mo_pool_bet,
                              vector<int>& _orb_indx_alp,
                              vector<int>& _orb_indx_bet) = &SD::set;
      ...
      complex<double> (*expt_overlap_sd_v1)(CMATRIX& Smo, vector<int>& SD1, vector<int>& SD2) =
          &overlap_sd;
      ...
      class_<SDList>("SDList").def(vector_indexing_suite<SDList>());
    }
