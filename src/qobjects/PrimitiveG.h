...
*/
    ...
    public:
      // Members data
      int x_exp;
      int is_x_exp;  ///< quantum number of the x-projection of the angular momentum operator
      int y_exp;
      int is_y_exp;  ///< quantum number of the y-projection of the angular momentum operator
      int z_exp;
      int is_z_exp;  ///< quantum number of the z-projection of the angular momentum operator
      double alpha;
      int is_alpha;  ///< Gaussian exponent
      VECTOR R;
      int is_R;  ///< coordinates (Cartesian) of the primitive
      // Function value
      double value;
      int is_value;  ///< The value of the function at some point
      ...
      PrimitiveG(
          int l, int m, int n, double alp, VECTOR& center);  ///< general c-tor, with parameters
    ...
    */
    ...
    double nuclear_attraction_integral(PrimitiveG& GA, PrimitiveG& GB, VECTOR& Rc, int is_normalize);
    ...
    typedef std::vector<PrimitiveG>
        PrimitiveGList;  ///< This is the data type for representing vector of PrimitiveG objects
