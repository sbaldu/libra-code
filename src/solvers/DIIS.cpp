...
*/
      ...
      int debug_flag = 0;
      double diis_damp =
          0.0;  // see [Hamilton,Pulay, JCP 84, 5728 (1986) ] - scale diagonal element of B matrix by (1+diis_damp) to
...
*/
      ...
      if (N_diis ==
          0) {  // The very first iterate (most likely this will be used right after guess)
        ...
        *diis_err[0] = *err;
        ...
        if (N_diis >=
            N_diis_max) {  // this happens because last call of add_diis_matrices incremented N_diis

          N_diis =
              N_diis_max -
              1;  // so we set N_diis to maximal valid index, pointing to the last entries in the arrays
