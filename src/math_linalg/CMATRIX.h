...
*/
      ...
      void get_components(MATRIX& re_part,
    ...
    typedef std::vector<CMATRIX>
        CMATRIXList;  ///< Data type holding a list of arbitrary-size complex-valued matrices
    typedef std::vector<vector<CMATRIX> >
        CMATRIXMap;  ///< Data type for storing the table (grid) of the arbitrary-size complex-valued matrices
