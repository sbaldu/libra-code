...
namespace liblibra {
  ...
  namespace liblinalg {
    ...
    void export_base_matrix() {
      ...
      void (*expt_pop_submatrix_v1)(base_matrix<T1>& X, base_matrix<T1>& x, vector<int>& subset) =
          &pop_submatrix;
      void (*expt_pop_submatrix_v2)(
          base_matrix<T1>& X, base_matrix<T1>& x, boost::python::list subset) = &pop_submatrix;
      void (*expt_pop_submatrix_v3)(
          base_matrix<T1>& X, base_matrix<T1>& x, vector<int>& subset, vector<int>& subset2) =
          &pop_submatrix;
      void (*expt_pop_submatrix_v4)(base_matrix<T1>& X,
                                    base_matrix<T1>& x,
                                    boost::python::list subset,
                                    boost::python::list subset2) = &pop_submatrix;

      void (*expt_push_submatrix_v1)(base_matrix<T1>& X, base_matrix<T1>& x, vector<int>& subset) =
          &push_submatrix;
      void (*expt_push_submatrix_v2)(
          base_matrix<T1>& X, base_matrix<T1>& x, boost::python::list subset) = &push_submatrix;
      void (*expt_push_submatrix_v3)(
          base_matrix<T1>& X, base_matrix<T1>& x, vector<int>& subset, vector<int>& subset2) =
          &push_submatrix;
      void (*expt_push_submatrix_v4)(base_matrix<T1>& X,
                                     base_matrix<T1>& x,
                                     boost::python::list subset,
                                     boost::python::list subset2) = &push_submatrix;

      void (*expt_add_submatrix_v1)(
          base_matrix<T1>& X, base_matrix<T1>& x, vector<int>& subset, T1 alpha) = &add_submatrix;
      void (*expt_add_submatrix_v2)(
          base_matrix<T1>& X, base_matrix<T1>& x, boost::python::list subset, T1 alpha) =
          &add_submatrix;
      void (*expt_add_submatrix_v3)(base_matrix<T1>& X,
                                    base_matrix<T1>& x,
                                    vector<int>& subset,
                                    vector<int>& subset2,
                                    T1 alpha) = &add_submatrix;
      void (*expt_add_submatrix_v4)(base_matrix<T1>& X,
                                    base_matrix<T1>& x,
                                    boost::python::list subset,
...
*/
      ...
      static boost::python::tuple getstate(const MATRIX& w) {
        ...
        for (int i = 0; i < w.n_elts; i++) {
          res = boost::python::extract<boost::python::tuple>(res +
                                                             boost::python::make_tuple(w.get(i)));
        }  // for i
    ...
    void export_MATRIX() {
      ...
      void (MATRIX::*expt_init_v1)(const VECTOR& u1, const VECTOR& u2, const VECTOR& u3) =
          &MATRIX::init;
...
*/
        ...
        static boost::python::tuple getstate(const MATRIXList& w) {
          ...
          for (int i = 0; i < sz; i++) {
            res =
                boost::python::extract<boost::python::tuple>(res + boost::python::make_tuple(w[i]));
          }  // for i
...
*/
    ...
    void export_MATRIX3x3() {
      ...
      class_<MATRIX3x3List>("MATRIX3x3List").def(vector_indexing_suite<MATRIX3x3List>());

      class_<MATRIX3x3Map>("MATRIX3x3Map").def(vector_indexing_suite<MATRIX3x3Map>());
    }
    ...
    void export_QUATERNION() {
      ...
      class_<QUATERNIONList>("QUATERNIONList").def(vector_indexing_suite<QUATERNIONList>());

      class_<QUATERNIONMap>("QUATERNIONMap").def(vector_indexing_suite<QUATERNIONMap>());
    }
    ...
    void export_FT() {
      ...
      void (*expt_inv_cft1_v1)(CMATRIX& in, CMATRIX& out, double xmin, double kmin, double dx) =
          &inv_cft1;
      ...
      void (*expt_cft1_2D_v1)(CMATRIX& in,
                              CMATRIX& out,
                              double xmin,
                              double ymin,
                              double kxmin,
                              ...
                              double dx,
                              double dy) = &cft1_2D;
      void (*expt_inv_cft1_2D_v1)(CMATRIX& in,
                                  CMATRIX& out,
                                  double xmin,
                                  double ymin,
                                  double kxmin,
      ...
      void (*expt_convolve_2D_v1)(CMATRIX& f, CMATRIX& g, CMATRIX& conv, double dx, double dy) =
          &convolve_2D;
      ...
      void (*expt_cfft1_v1)(CMATRIX& in, CMATRIX& out, double xmin, double kmin, double dx) =
          &cfft1;
      void (*expt_inv_cfft1_v1)(CMATRIX& in, CMATRIX& out, double xmin, double kmin, double dx) =
          &inv_cfft1;
      def("cfft", expt_cfft1_v1);
      def("inv_cfft", expt_inv_cfft1_v1);

      void (*expt_cfft1_2D_v1)(CMATRIX& in,
                               CMATRIX& out,
                               double xmin,
                               double ymin,
                               double kxmin,
                               ...
                               double dx,
                               double dy) = &cfft1_2D;
      void (*expt_inv_cfft1_2D_v1)(CMATRIX& in,
                                   CMATRIX& out,
                                   double xmin,
                                   double ymin,
                                   double kxmin,
    ...
    void export_permutations() {
      ...
      vector<int> (*expt_composite_permutation_v1)(vector<int>& perm_t, vector<int>& perm_cum) =
          &composite_permutation;
      def("composite_permutation", expt_composite_permutation_v1);

      void (*expt_update_permutation_v1)(vector<int>& perm_t, vector<int>& perm_cum) =
          &update_permutation;
...
*/
      ...
      class_<complexList2>("complexList2").def(vector_indexing_suite<complexList2>());
      ...
      class_<complexList3>("complexList3").def(vector_indexing_suite<complexList3>());
