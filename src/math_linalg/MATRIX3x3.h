...
namespace liblibra {
  ...
  namespace liblinalg {
    ...
    public:
      ...
      double Determinant() {
        return (xx * (yy * zz - yz * zy) - yx * (xy * zz - zy * xz) + zx * (xy * yz - yy * xz));
      }
      ...
      friend bool operator==(const MATRIX3x3& m1, const MATRIX3x3& m2) {
        // Are matrices equal
        return ((m1.xx == m2.xx) && (m1.xy == m2.xy) && (m1.xz == m2.xz) && (m1.yx == m2.yx) &&
                (m1.yy == m2.yy) && (m1.yz == m2.yz) && (m1.zx == m2.zx) && (m1.zy == m2.zy) &&
                (m1.zz == m2.zz));
      }
      friend bool operator!=(const MATRIX3x3& m1, const MATRIX3x3& m2) {
      ...
      friend VECTOR operator*(const MATRIX3x3& m,
