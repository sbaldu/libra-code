...
*/
  ...
  */
        if (n_rows * n_cols != x.n_rows) {
          ...
          std::cout << " matrix (" << n_rows << " , " << n_cols << "), that is " << n_rows * n_cols
                    << " elements\n";
          std::cout << "Exiting...\n";
        }
...
*/
  ...
  */
        ...
        if (B.n_cols != C.n_rows) {
          ...
          std::cout << "You try to muplitpy a " << B.n_rows << " by " << B.n_cols
                    << " matrix and a " << C.n_rows << " by " << C.n_cols << " matrix\n";
          std::cout << "Exiting...\n";
          exit(0);
        }
        ...
        if (n_rows != B.n_rows) {
          std::cout << "The number of rows of the target matrix (" << n_rows
                    << ") doesn't match the number of rows of the first multiplier matrix ("
                    << B.n_rows << ")\n";
          std::cout << "Exiting...\n";
          exit(0);
        }
        if (n_cols != C.n_cols) {
          std::cout << "The number of cols of the target matrix (" << n_cols
                    << ") doesn't match the number of cols of the second multiplier matrix ("
                    << C.n_cols << ")\n";
          std::cout << "Exiting...\n";
          exit(0);
        }
  ...
  */
        ...
        if (n_rows != _M * _P) {
          std::cout << "Kronecker product error: The target matrix should have " << n_rows
                    << " rows";
          std::cout << " but the Kronecker product of matrices with " << _M << " and " << _P
                    << " rows would";
        ...
        if (n_cols != _N * _Q) {
          std::cout << "Kronecker product error: The target matrix should have " << n_cols
                    << " columns";
          std::cout << " but the Kronecker product of matrices with " << _N << " and " << _Q
                    << " columns would";
  ...
  */
        ...
        if (ob1.n_cols != ob2.n_cols) {
          std::cout << "Error in direct CMATRIX multiplication: Number of columns of multiplying "
        ...
        if (ob1.n_rows != ob2.n_rows) {
          std::cout << "Error in direct CMATRIX multiplication: Number of rows of multiplying "
                       "matrices must be equal\n";
          std::cout << "Exiting...\n";
          exit(0);
        }
        ...
        if (n_cols != ob2.n_cols) {
          std::cout << "Error in direct CMATRIX multiplication: Number of columns of the "
        ...
        if (n_rows != ob2.n_rows) {
          std::cout << "Error in direct CMATRIX multiplication: Number of rows of the multiplying "
                       "CMATRIX and target CMATRIX must be equal\n";
          std::cout << "Exiting...\n";
          exit(0);
        }
...
*/
      ...
      void swap_cols(int I, int J) {  ///< Swaps two columns
        ...
        if (I >= n_cols) {
          ...
          cout << "The index of one column (" << I << ") is larger than the number of columns ("
               << n_cols << ")\n";
          exit(0);
        }
        if (J >= n_cols) {
          cout << "Error in base_matrix<T>::swap_cols\n";
          cout << "The index of one column (" << J << ") is larger than the number of columns ("
               << n_cols << ")\n";
          exit(0);
        }
      ...
      T1 sum_col(
          int icol,
          int power) {  ///< Compute the sum of n-th power of matrix elements in a given column
        T1 res = 0.0;
        for (int irow = 0; irow < n_rows; irow++) {
          T1 tn = (T1)1.0;
      ...
      T1 sum_row(int irow,
                 int power) {  ///< Compute the sum of n-th power of matrix elements in a given row
        T1 res = 0.0;
        for (int icol = 0; icol < n_cols; icol++) {
          T1 tn = (T1)1.0;
          T1 t1 = M[irow * n_cols + icol];
...
*/
      ...
      if (X->n_cols != X->n_rows) {
        cout << "Error in pop_submatrix: The source matrix, X, is not square!\nExiting...\n";
        exit(0);
      }
      if (x->n_cols != x->n_rows) {
        cout << "Error in pop_submatrix: The target matrix, x, is not square!\nExiting...\n";
        exit(0);
      }
      ...
      if (N < n) {
        cout << "Error in pop_submatrix: The size of the source matrix, X, is smaller than that of "
                "the target matrix, x!\nExiting...\n";
        exit(0);
      }
      if (n != subset.size()) {
    ...
    template <typename T1>
    void pop_submatrix(base_matrix<T1>* X,
                       base_matrix<T1>* x,
                       vector<int>& subset,
                       vector<int>& subset2) {
      /**
...
*/
      ...
      if (X->n_cols < x->n_cols) {
        cout << "Error in pop_submatrix: The # of cols of the source matrix, X, is smaller than "
                "that of the target matrix, x!\nExiting...\n";
        exit(0);
      }
      if (X->n_rows < x->n_rows) {
        cout << "Error in pop_submatrix: The # of rows of the source matrix, X, is smaller than "
                "that of the target matrix, x!\nExiting...\n";
        exit(0);
      }
      if (x->n_rows != subset.size()) {
        cout << "Error in pop_submatrix: # of rows in the target matrix (" << x->n_rows
             << ") is not consistent with the stensil size (";
        cout << subset.size() << ")!\nExiting...\n";
        exit(0);
      }
      if (x->n_cols != subset2.size()) {
        cout << "Error in pop_submatrix: # of cols in the target matrix (" << x->n_cols
             << ") is not consistent with the stensil size (";
        cout << subset2.size() << ")!\nExiting...\n";
        exit(0);
      }
...
*/
      ...
      if (X->n_cols != X->n_rows) {
        cout << "Error in push_submatrix: The target matrix, X, is not square!\nExiting...\n";
        exit(0);
      }
      if (x->n_cols != x->n_rows) {
        cout << "Error in push_submatrix: The source matrix, x, is not square!\nExiting...\n";
        exit(0);
      }
      ...
      if (N < n) {
        cout << "Error in push_submatrix: The size of the target matrix, X, is smaller than that "
                "of the source matrix, x!\nExiting...\n";
        exit(0);
      }
      if (n != subset.size()) {
    ...
    template <typename T1>
    void push_submatrix(base_matrix<T1>* X,
                        base_matrix<T1>* x,
                        vector<int>& subset,
                        vector<int>& subset2) {
      /**
...
*/
      ...
      if (X->n_cols < x->n_cols) {
        cout << "Error in push_submatrix: The # of cols of the target matrix, X, is smaller than "
                "that of the source matrix, x!\nExiting...\n";
        exit(0);
      }
      if (X->n_rows < x->n_rows) {
        cout << "Error in push_submatrix: The # of rows of the target matrix, X, is smaller than "
                "that of the source matrix, x!\nExiting...\n";
        exit(0);
      }
      if (x->n_rows != subset.size()) {
        cout << "Error in push_submatrix: # of rows in the source matrix (" << x->n_rows
             << ") is not consistent with the stensil size (";
        cout << subset.size() << ")!\nExiting...\n";
        exit(0);
      }
      if (x->n_cols != subset2.size()) {
        cout << "Error in push_submatrix: # of cols in the source matrix (" << x->n_cols
             << ") is not consistent with the stensil size (";
        cout << subset2.size() << ")!\nExiting...\n";
        exit(0);
      }
...
*/
    ...
    template <typename T1>
    void add_submatrix(base_matrix<T1>& X,
                       base_matrix<T1>& x,
                       boost::python::list subset,
                       T1 alpha) {
