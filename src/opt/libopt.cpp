...
*/
      ...
      double (*expt_derivs1_v1)(MATRIX& x,
                                MATRIX& y,
                                MATRIX& A,
                                MATRIX& gradA,
                                double& L,
      ...
      double (*expt_derivs1_new_v1)(MATRIX& x,
                                    MATRIX& y,
                                    MATRIX& A,
                                    MATRIX& gradA,
                                    double& L,
      ...
      double (*expt_derivs2_v1)(MATRIX& x,
                                MATRIX& y,
                                MATRIX& A,
                                MATRIX& gradA,
                                MATRIX& mu,
      ...
      double (*expt_derivs3_v1)(MATRIX& x,
                                MATRIX& y,
                                MATRIX& A,
                                MATRIX& gradA,
                                double& L,
      ...
      (bp::object grad_function,
       MATRIX & dof,
       bp::object funct_params,
       double grad_tol,
       double step_size,
       int max_steps) = &grad_descent;

      def("grad_descent", expt_grad_descent_v1);

      void (*expt_grad_step_v1)(MATRIX& A,
                                MATRIX& x,
                                MATRIX& x_new,
                                double dt,
                                double& L,
