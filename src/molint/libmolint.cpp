...
*/
      ...
      // Basic overlaps
      // 1D Gaussians
      double (*expt_gaussian_overlap_ref)(int, double, double, int, double, double) =
          &gaussian_overlap_ref;
      double (*expt_gaussian_overlap_1D_v1)(int, double, double, int, double, double) =
          &gaussian_overlap;
      double (*expt_gaussian_overlap_1D_v2)(int, double, double, int, double, double, int) =
          &gaussian_overlap;
      boost::python::list (*expt_gaussian_overlap_1D_v3)(
          int, double, double, int, double, double, int, int) = &gaussian_overlap;

      // 3D Gaussians
      double (*expt_gaussian_overlap_3D_v1)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&) = &gaussian_overlap;
      double (*expt_gaussian_overlap_3D_v2)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&, int) = &gaussian_overlap;
      boost::python::list (*expt_gaussian_overlap_3D_v3)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&, int, int) =
          &gaussian_overlap;

      // Moments
      // 1D Moments
      double (*expt_gaussian_moment_ref)(
          int, double, double, int, double, double, int, double, double) = &gaussian_moment_ref;
      double (*expt_gaussian_moment_1D_v1)(
          int, double, double, int, double, double, int, double, double) = &gaussian_moment;
      double (*expt_gaussian_moment_1D_v2)(
          int, double, double, int, double, double, int, double, double, int) = &gaussian_moment;
      boost::python::list (*expt_gaussian_moment_1D_v3)(
          int, double, double, int, double, double, int, double, double, int, int) =
          &gaussian_moment;

      // 3D Moments
      double (*expt_gaussian_moment_3D_v1)(int,
                                           int,
                                           int,
                                           double,
                                           const VECTOR&,
                                           ...
                                           int,
                                           double,
                                           const VECTOR&) = &gaussian_moment;
      double (*expt_gaussian_moment_3D_v2)(int,
                                           int,
                                           int,
                                           double,
                                           const VECTOR&,
                                           ...
                                           const VECTOR&,
                                           int) = &gaussian_moment;
      boost::python::list (*expt_gaussian_moment_3D_v3)(int,
                                                        int,
                                                        int,
                                                        double,
                                                        const VECTOR&,
      ...
      // Pseudopotentials
      // 3D pseudopotentials
      double (*expt_pseudopot02_v1)(double,
                                    double,
                                    double,
                                    const VECTOR&,
                                    int,
                                    ...
                                    int,
                                    double,
                                    const VECTOR&) = &pseudopot02;
      boost::python::list (*expt_pseudopot02_v2)(double,
                                                 double,
                                                 double,
                                                 const VECTOR&,
                                                 int,
      ...
      double (*expt_transition_dipole_moment_1D_v2)(
          int nxa, double alp_a, double Xa, int nxb, double alp_b, double Xb, int is_normalize) =
          &transition_dipole_moment;
      boost::python::list (*expt_transition_dipole_moment_1D_v3)(int nxa,
                                                                 double alp_a,
                                                                 double Xa,
                                                                 int nxb,
                                                                 double alp_b,
      ...
      (int nxa,
       ...
       int nzb,
       double alp_b,
       const VECTOR& Rb) = &transition_dipole_moment;
      ...
      (int nxa,
       ...
       double alp_b,
       const VECTOR& Rb,
       int is_normalize) = &transition_dipole_moment;
      boost::python::list (*expt_transition_dipole_moment_3D_v3)(int nxa,
                                                                 int nya,
                                                                 int nza,
                                                                 double alp_a,
                                                                 const VECTOR& Ra,
      ...
      // 1D KEI
      double (*expt_kinetic_integral_1D_v1)(int, double, double, int, double, double) =
          &kinetic_integral;
      double (*expt_kinetic_integral_1D_v2)(int, double, double, int, double, double, int) =
          &kinetic_integral;
      boost::python::list (*expt_kinetic_integral_1D_v3)(
          int, double, double, int, double, double, int, int) = &kinetic_integral;

      // 3D KEI
      double (*expt_kinetic_integral_3D_v1)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&) = &kinetic_integral;
      double (*expt_kinetic_integral_3D_v2)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&, int) = &kinetic_integral;
      boost::python::list (*expt_kinetic_integral_3D_v3)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&, int, int) =
          &kinetic_integral;

      // Nuclear attraction integrals (3D)
      double (*expt_nuclear_attraction_integral_v1)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&, VECTOR&) =
          &nuclear_attraction_integral;
      double (*expt_nuclear_attraction_integral_v2)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&, VECTOR&, int) =
          &nuclear_attraction_integral;
      boost::python::list (*expt_nuclear_attraction_integral_v3)(
          int, int, int, double, VECTOR&, int, int, int, double, VECTOR&, VECTOR&, int, int) =
          &nuclear_attraction_integral;

      // Electron repulsion integrals
      double (*expt_electron_repulsion_integral_v1)(int,
                                                    int,
                                                    int,
                                                    double,
                                                    VECTOR&,
                                                    ...
                                                    int,
                                                    double,
                                                    VECTOR&) = &electron_repulsion_integral;

      double (*expt_electron_repulsion_integral_v2)(int,
                                                    int,
                                                    int,
                                                    double,
                                                    VECTOR&,
                                                    ...
                                                    double,
                                                    VECTOR&,
                                                    int) = &electron_repulsion_integral;

      boost::python::list (*expt_electron_repulsion_integral_v3)(int,
                                                                 int,
                                                                 int,
                                                                 double,
                                                                 VECTOR&,
      ...
      boost::python::list (*expt_derivative_coupling_integral_1D_v3)(int nxa,
                                                                     double alp_a,
                                                                     double Xa,
                                                                     int nxb,
                                                                     double alp_b,
      ...
      (int nxa,
       ...
       int nzb,
       double alp_b,
       VECTOR& Rb) = &derivative_coupling_integral;
      ...
      (int nxa,
       ...
       double alp_b,
       VECTOR& Rb,
       int is_normalize) = &derivative_coupling_integral;

      boost::python::list (*expt_derivative_coupling_integral_3D_v3)(int nxa,
                                                                     int nya,
                                                                     int nza,
                                                                     double alp_a,
                                                                     VECTOR& Ra,
      ...
      double (*expt_Coulomb_Integral_v1)(double R,
                                         int n_i,
                                         double Jii,
                                         double ksi_i,
                                         std::string type_i,
